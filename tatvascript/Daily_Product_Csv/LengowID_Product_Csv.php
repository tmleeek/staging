...
$filename = "lengowid_product_csv.csv";
$fp = fopen($filename, "w");
...
$line.= '"LengowID","COST","CURRENCY","CREATED_DATE"';
$line.= "\n";
...
$collections->joinAttribute('lengow_id', 'catalog_product/lengow_id', 'entity_id', null, 'left', $storeId);
...
if($totalProd > 0)
{
	foreach($collections as $product_data)
    {
        ...
        $p_sku = $product_data->getLengowId();
