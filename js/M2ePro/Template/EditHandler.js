TemplateEditHandler = Class.create(CommonHandler, {
    ...
    {
        var skipConfirmation = getCookie(this.getComponent()+'_template_'+templateNick+'_skip_save_confirmation');
            ...
            Dialog._openDialog(template.innerHTML, {
                ...
                ok: function() {
                    if ($('do_not_show_again').checked) {
                        setCookie(me.getComponent()+'_template_'+templateNick+'_skip_save_confirmation', 1, 3*365, '/');
                    }
