...
use MageBackup\Aws\Multipart\AbstractUploader;
use MageBackup\Aws\Multipart\UploadState;
use MageBackup\Aws\PhpHash;
use MageBackup\Aws\ResultInterface;
use MageBackup\GuzzleHttp\Psr7;
use MageBackup\Psr\Http\Message\StreamInterface as Stream;
...
class MultipartUploader extends AbstractUploader
{
     ...
     *   signature like `function (MageBackup\Aws\Command $command) {...}`.
     ...
     * - state: (MageBackup\Aws\Multipart\UploadState) An object that represents the state
