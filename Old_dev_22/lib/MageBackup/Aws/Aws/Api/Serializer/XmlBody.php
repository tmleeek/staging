<?php
namespace MageBackup\Aws\Api\Serializer;

use MageBackup\Aws\Api\MapShape;
use MageBackup\Aws\Api\Service;
use MageBackup\Aws\Api\Shape;
use MageBackup\Aws\Api\StructureShape;
use MageBackup\Aws\Api\ListShape;
use MageBackup\Aws\Api\TimestampShape;
use XMLWriter;
...
class XmlBody
{
    /** @var \MageBackup\Aws\Api\Service */
    private $api;
