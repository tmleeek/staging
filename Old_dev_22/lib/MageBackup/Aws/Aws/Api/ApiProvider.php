...
use MageBackup\Aws\Exception\UnresolvedApiException;
 ...
 * {@see MageBackup\Aws\Exception\UnresolvedApiException}.
 *
 ...
 * {@see MageBackup\Aws\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \MageBackup\Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \MageBackup\Aws\load_compiled_json($path);
