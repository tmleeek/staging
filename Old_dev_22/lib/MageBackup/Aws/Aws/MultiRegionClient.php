...
use MageBackup\Aws\Endpoint\PartitionInterface;
...
class MultiRegionClient implements AwsClientInterface
{
        ...
        return $args + [
            'client_factory' => [
                ...
                'default' => function (array $args) {
                    ...
                    $klass = "MageBackup\Aws\\{$namespace}\\{$namespace}Client";
     ...
     * - partition: (MageBackup\Aws\Endpoint\Partition|string) AWS partition to connect to.
