...
interface AwsClientInterface
{
     ...
     * {@see \MageBackup\Aws\Credentials\CredentialsInterface} object.
     *
     ...
     *
     * @return \MageBackup\Aws\Api\Service
     */
     ...
     *
     * @return \MageBackup\Aws\ResultPaginator
     * @throws \UnexpectedValueException if the iterator config is invalid.
     */
