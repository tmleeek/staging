<?php
namespace MageBackup\GuzzleHttp\Psr7;

use MageBackup\Psr\Http\Message\MessageInterface;
 ...
 *
 * This function accepts a string or {@see MageBackup\Psr\Http\Message\UriInterface} and
