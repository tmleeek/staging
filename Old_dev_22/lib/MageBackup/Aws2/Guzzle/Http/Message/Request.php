...
namespace MageBackup\Guzzle\Http\Message;

use MageBackup\Guzzle\Common\Version;
...
use MageBackup\Guzzle\Http\Exception\RequestException;
use MageBackup\Guzzle\Http\Exception\BadResponseException;
use MageBackup\Guzzle\Http\ClientInterface;
use MageBackup\Guzzle\Http\EntityBody;
use MageBackup\Guzzle\Http\EntityBodyInterface;
use MageBackup\Guzzle\Http\Message\Header\HeaderInterface;
use MageBackup\Guzzle\Http\Url;
use MageBackup\Guzzle\Parser\ParserRegistry;
use MageBackup\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /**
     * @deprecated Use MageBackup\Guzzle\Plugin\Cache\DefaultCanCacheStrategy
     * @codeCoverageIgnore
     */
    public function canCache()
    {
        Version::warn(__METHOD__ . ' is deprecated. Use MageBackup\Guzzle\Plugin\Cache\DefaultCanCacheStrategy.');
        if (class_exists('MageBackup\Guzzle\Plugin\Cache\DefaultCanCacheStrategy')) {
            $canCache = new \MageBackup\Guzzle\Plugin\Cache\DefaultCanCacheStrategy();
