...
use MageBackup\Guzzle\Stream\StreamRequestFactoryInterface;
...
final class StaticClient
{
     ...
     * @param  array  $options Options to use with the request. See: MageBackup\Guzzle\Http\Message\RequestFactory::applyOptions()
     * @return \MageBackup\Guzzle\Http\Message\Response|\MageBackup\Guzzle\Stream\Stream
     */
     ...
     *
     * @return \MageBackup\Guzzle\Http\Message\Response
