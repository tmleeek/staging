...
use MageBackup\Guzzle\Http\QueryAggregator\QueryAggregatorInterface;
use MageBackup\Guzzle\Http\QueryAggregator\PhpAggregator;
...
class QueryString extends Collection
{
     ...
     * @return self
     * @see \MageBackup\Guzzle\Http\QueryString::aggregateUsingComma()
     */
