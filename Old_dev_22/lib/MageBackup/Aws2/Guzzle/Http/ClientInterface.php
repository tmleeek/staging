...
use MageBackup\Guzzle\Common\HasDispatcherInterface;
use MageBackup\Guzzle\Common\Collection;
use MageBackup\Guzzle\Common\Exception\InvalidArgumentException;
use MageBackup\Guzzle\Http\Message\EntityEnclosingRequestInterface;
...
interface ClientInterface extends HasDispatcherInterface
{
     ...
     * @see \MageBackup\Guzzle\Http\Message\RequestFactoryInterface::applyOptions for a full list of request.options options
     */
     ...
     * @return RequestInterface
     * @see    MageBackup\Guzzle\Http\ClientInterface::createRequest()
     */
     ...
     *
     * @return \MageBackup\Guzzle\Http\Message\Response|array Returns a single Response or an array of Response objects
     */
