...
namespace MageBackup\Guzzle\Http;

use MageBackup\Guzzle\Common\Collection;
use MageBackup\Guzzle\Common\AbstractHasDispatcher;
use MageBackup\Guzzle\Common\Exception\ExceptionCollection;
...
use MageBackup\Guzzle\Parser\UriTemplate\UriTemplateInterface;
use MageBackup\Guzzle\Http\Message\RequestInterface;
use MageBackup\Guzzle\Http\Message\RequestFactory;
use MageBackup\Guzzle\Http\Message\RequestFactoryInterface;
use MageBackup\Guzzle\Http\Curl\CurlMultiInterface;
use MageBackup\Guzzle\Http\Curl\CurlMultiProxy;
use MageBackup\Guzzle\Http\Curl\CurlHandle;
use MageBackup\Guzzle\Http\Curl\CurlVersion;
