...
namespace MageBackup\Guzzle\Batch\Exception;

use MageBackup\Guzzle\Common\Exception\GuzzleException;
use MageBackup\Guzzle\Batch\BatchTransferInterface as TransferStrategy;
use MageBackup\Guzzle\Batch\BatchDivisorInterface as DivisorStrategy;
