...
namespace MageBackup\Guzzle\Batch;

use MageBackup\Guzzle\Batch\BatchTransferInterface;
use MageBackup\Guzzle\Batch\BatchDivisorInterface;
use MageBackup\Guzzle\Common\Exception\InvalidArgumentException;
use MageBackup\Guzzle\Service\Command\CommandInterface;
use MageBackup\Guzzle\Service\Exception\InconsistentClientTransferException;

/**
 * Efficiently transfers multiple commands in parallel per client
 * This class is to be used with {@see MageBackup\Guzzle\Batch\BatchInterface}
 */
    ...
    public function createBatches(\SplQueue $queue)
    {
        ...
        foreach ($queue as $item) {
            if (!$item instanceof CommandInterface) {
                throw new InvalidArgumentException('All items must implement MageBackup\Guzzle\Service\Command\CommandInterface');
            }
