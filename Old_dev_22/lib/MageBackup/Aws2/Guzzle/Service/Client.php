...
namespace MageBackup\Guzzle\Service;

use MageBackup\Guzzle\Common\Collection;
use MageBackup\Guzzle\Common\Exception\InvalidArgumentException;
use MageBackup\Guzzle\Common\Exception\BadMethodCallException;
use MageBackup\Guzzle\Common\Version;
use MageBackup\Guzzle\Inflection\InflectorInterface;
use MageBackup\Guzzle\Inflection\Inflector;
use MageBackup\Guzzle\Http\Client as HttpClient;
use MageBackup\Guzzle\Http\Exception\MultiTransferException;
use MageBackup\Guzzle\Service\Exception\CommandTransferException;
...
use MageBackup\Guzzle\Service\Command\Factory\FactoryInterface as CommandFactoryInterface;
use MageBackup\Guzzle\Service\Resource\ResourceIteratorClassFactory;
use MageBackup\Guzzle\Service\Resource\ResourceIteratorFactoryInterface;
