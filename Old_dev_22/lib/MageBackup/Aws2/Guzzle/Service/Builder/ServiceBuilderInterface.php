...
namespace MageBackup\Guzzle\Service\Builder;

use MageBackup\Guzzle\Service\Exception\ServiceNotFoundException;

/**
 * Service builder used to store and build clients or arbitrary data. Client configuration data can be supplied to tell
 * the service builder how to create and cache {@see \MageBackup\Guzzle\Service\ClientInterface} objects. Arbitrary data can be
...
interface ServiceBuilderInterface
{
     ...
     *                              client if the client implements {@see \MageBackup\Guzzle\Common\FromConfigInterface} and will
     *                              not store the client for later retrieval.
     *
     * @return \MageBackup\Guzzle\Service\ClientInterface|mixed
