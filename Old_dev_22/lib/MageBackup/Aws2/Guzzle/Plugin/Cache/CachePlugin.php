...
use MageBackup\Guzzle\Cache\CacheAdapterFactory;
...
use MageBackup\Doctrine\Common\Cache\ArrayCache;
...
class CachePlugin implements EventSubscriberInterface
{
    ...
    public function __construct($options = null)
    {
        if (!is_array($options)) {
            ...
            } elseif (!class_exists('MageBackup\Doctrine\Common\Cache\ArrayCache')) {
