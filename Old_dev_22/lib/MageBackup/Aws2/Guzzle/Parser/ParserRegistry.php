...
namespace MageBackup\Guzzle\Parser;
...
class ParserRegistry
{
    ...
    protected $mapping = array(
        'message'      => 'MageBackup\Guzzle\\Parser\\Message\\MessageParser',
        'cookie'       => 'MageBackup\Guzzle\\Parser\\Cookie\\CookieParser',
        'url'          => 'MageBackup\Guzzle\\Parser\\Url\\UrlParser',
        'uri_template' => 'MageBackup\Guzzle\\Parser\\UriTemplate\\UriTemplate',
    );
    ...
    public function __construct()
    {
        ...
        if (extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'MageBackup\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
