...
use MageBackup\Aws\S3\Exception\NoSuchKeyException;
use MageBackup\Aws\S3\Iterator\ListObjectsIterator;
use MageBackup\Guzzle\Http\EntityBody;
use MageBackup\Guzzle\Http\CachingEntityBody;
use MageBackup\Guzzle\Http\Mimetypes;
use MageBackup\Guzzle\Iterator\FilterIterator;
use MageBackup\Guzzle\Stream\PhpStreamRequestFactory;
...
class StreamWrapper
{
    ...
    protected function openReadStream(array $params, array &$errors)
    {
        ...
        $this->body = $factory->fromRequest($request, array(), array('stream_class' => 'MageBackup\Guzzle\Http\EntityBody'));
