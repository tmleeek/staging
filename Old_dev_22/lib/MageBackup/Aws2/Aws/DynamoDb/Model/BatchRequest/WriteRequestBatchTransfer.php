...
namespace MageBackup\Aws\DynamoDb\Model\BatchRequest;

use MageBackup\Aws\Common\Client\AwsClientInterface;
use MageBackup\Aws\Common\Enum\UaString as Ua;
use MageBackup\Aws\DynamoDb\Exception\DynamoDbException;
use MageBackup\Aws\DynamoDb\Exception\UnprocessedWriteRequestsException;
use MageBackup\Guzzle\Batch\BatchTransferInterface;
...
class WriteRequestBatchTransfer implements BatchTransferInterface
{
     ...
     *
     * @throws \MageBackup\Guzzle\Common\Exception\ExceptionCollection
     */
