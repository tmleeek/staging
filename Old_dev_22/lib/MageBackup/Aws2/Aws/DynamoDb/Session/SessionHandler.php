...
namespace MageBackup\Aws\DynamoDb\Session;

use MageBackup\Aws\Common\Enum\UaString as Ua;
use MageBackup\Aws\DynamoDb\DynamoDbClient;
use MageBackup\Aws\DynamoDb\Session\LockingStrategy\LockingStrategyInterface;
use MageBackup\Aws\DynamoDb\Session\LockingStrategy\LockingStrategyFactory;
use MageBackup\Aws\DynamoDb\Model\BatchRequest\WriteRequestBatch;
use MageBackup\Aws\DynamoDb\Model\BatchRequest\DeleteRequest;
