...
namespace MageBackup\Aws\Common\Hash;

use MageBackup\Aws\Common\Enum\Size;
use MageBackup\Aws\Common\Exception\InvalidArgumentException;
use MageBackup\Aws\Common\Exception\LogicException;
...
class TreeHash implements ChunkHashInterface
{
    ...
    public static function fromChecksums(array $checksums, $inBinaryForm = false, $algorithm = self::DEFAULT_ALGORITHM)
    {
        ...
        $treeHash->checksums = $inBinaryForm ? $checksums : array_map('MageBackup\Aws\Common\Hash\HashUtils::hexToBin', $checksums);
