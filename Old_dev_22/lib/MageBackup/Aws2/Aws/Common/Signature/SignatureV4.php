...
namespace MageBackup\Aws\Common\Signature;

use MageBackup\Aws\Common\Credentials\CredentialsInterface;
use MageBackup\Aws\Common\Enum\DateFormat;
use MageBackup\Aws\Common\HostNameUtils;
...
use MageBackup\Guzzle\Http\QueryString;
use MageBackup\Guzzle\Http\Url;
use MageBackup\Guzzle\Stream\Stream;
