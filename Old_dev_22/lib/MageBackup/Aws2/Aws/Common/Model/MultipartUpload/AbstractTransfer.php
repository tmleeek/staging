...
namespace MageBackup\Aws\Common\Model\MultipartUpload;

use MageBackup\Aws\Common\Client\AwsClientInterface;
use MageBackup\Aws\Common\Exception\MultipartUploadException;
...
use MageBackup\Guzzle\Service\Command\OperationCommand;
