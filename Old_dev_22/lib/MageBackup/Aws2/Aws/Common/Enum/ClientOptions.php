...
namespace MageBackup\Aws\Common\Enum;
...
class ClientOptions extends Enum
{
     ...
     * `MageBackup\Aws\Common\Credentials\CredentialsInterface`.
     */
     ...
     *             default APC cache or provide a `MageBackup\Guzzle\Cache\CacheAdapterInterface` object.
     */
    ...
    /**
     * @var string Pass this option to specify a custom `MageBackup\Guzzle\Http\ClientInterface` to use if your credentials require
    ...
    /**
     * @var string `MageBackup\Guzzle\Log\LogAdapterInterface` object used to log backoff retries. Use 'debug' to emit PHP
     ...
     *             `MageBackup\Guzzle\Plugin\Backoff\BackoffLogger` for formatting information.
     */
