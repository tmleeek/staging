...
use Exception;
use MageBackup\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \MageBackup\Monolog\Logger('all', array(new \MageBackup\Monolog\Handler\PHPConsoleHandler()));
 *      \MageBackup\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('MageBackup\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param array $options See \MageBackup\Monolog\Handler\PHPConsoleHandler::$options for more details
