...
namespace MageBackup\Symfony\Component\EventDispatcher\Tests\DependencyInjection;

use MageBackup\Symfony\Component\DependencyInjection\ContainerBuilder;
use MageBackup\Symfony\Component\EventDispatcher\DependencyInjection\RegisterListenersPass;
...
class RegisterListenersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEventSubscriberWithoutInterface()
    {
        ...
        $definition = $this->getMock('MageBackup\MageBackup\Symfony\Component\DependencyInjection\Definition');
        ...
        $builder = $this->getMock(
            'MageBackup\MageBackup\Symfony\Component\DependencyInjection\ContainerBuilder',
    ...
    public function testValidEventSubscriber()
    {
        ...
        $definition->expects($this->atLeastOnce())
            ->method('getClass')
            ->will($this->returnValue('MageBackup\MageBackup\Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService'));
    ...
    public function testEventSubscriberResolvableClassName()
    {
        ...
        $container->setParameter('subscriber.class', 'MageBackup\MageBackup\Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService');
        ...
        $expected_calls = array(
            array(
                ...
                array(
                    'foo',
                    'MageBackup\MageBackup\Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService',
                ),
            ),
        );
...
class SubscriberService implements \MageBackup\MageBackup\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
