...
abstract class AbstractEventDispatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDispatch()
    {
        ...
        $this->assertInstanceOf('MageBackup\MageBackup\Symfony\Component\EventDispatcher\Event', $this->dispatcher->dispatch('noevent'));
        $this->assertInstanceOf('MageBackup\MageBackup\Symfony\Component\EventDispatcher\Event', $this->dispatcher->dispatch(self::preFoo));
        $event = new Event();
    ...
    public function testAddSubscriberWithPriorities()
    {
        ...
        $this->assertInstanceOf('MageBackup\MageBackup\Symfony\Component\EventDispatcher\Tests\TestEventSubscriberWithPriorities', $listeners[0][0]);
    }
