...
class Addonline_SoColissimo_Block_Adminhtml_System_Config_Form_Field_Liberte extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    {
        return '<button type="button" class="scalable" onclick="window.open(\'' . $this->getUrl('adminhtml/socolissimobatch_batch') . '\');"><span>Lancer l\'import manuellement</span></button>' . $element->getElementHtml();
    }
}
