...
class Mage_Catalog_Model_Layer_Filter_Item extends Varien_Object
{
    ...
    {    //echo $this->getFilter()->getRequestVar();
        if($this->getFilter()->getRequestVar()=='gamme_collection_new')
        {
          $value_new=$this->getCustomKey($this->getValue());
        }
        elseif($this->getFilter()->getRequestVar()=='manufacturer')
        {                                                           
         $value_new=$this->getCustomKey($this->getValue());
        }
        else
        {
          $value_new=$this->getValue();
        }
        $query = array(
            $this->getFilter()->getRequestVar()=>$value_new,
            Mage::getBlockSingleton('page/html_pager')->getPageVarName() => null // exclude current page from urls
        );

        //echo Mage::getUrl('*/*/*', array('_current'=>true, '_use_rewrite'=>true, '_query'=>$query));
