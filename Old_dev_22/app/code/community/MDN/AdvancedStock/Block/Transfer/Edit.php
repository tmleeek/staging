    ...
    public function __construct() {
        ...
        if ($this->getTransfer()->getId()) {
            ...
            $this->_addButton(
                ...
                'onclick' => "if (confirm('" . $this->__('Are you sure ? this will create the stock movements for products in transfer') . "')) {window.location.href='" . $this->getUrl('AdvancedStock/Transfer/Apply', array('st_id' => $this->getTransfer()->getId())) . "'}",
                'level' => -1
                    )
            );
            ...
            $this->_addButton(
                ...
                'onclick' => "document.location.href='".Mage::helper('adminhtml')->getUrl('AdvancedStock/Transfer/AddProductsWithScanner', array('st_id' => $this->getTransfer()->getId()))."'",
                'class' => 'add',
                'level' => -1
                    )
            );
