    ...
    public function applyWarehouseChange($oldWarehouseId, $newWarehouseId) {
        ...
        if ($parentItemId) {
            ...
            $parentItem->setpreparation_warehouse($newWarehouseId)->save();
              $debug .= ' parentItemId setpreparation_warehouse for $parentItemId='.$parentItemId;
        }
