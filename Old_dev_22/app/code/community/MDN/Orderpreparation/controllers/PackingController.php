...
class MDN_Orderpreparation_PackingController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function CommitAction()
    {
        ...
        try
        {
            ...
            if (Mage::getStoreConfig('orderpreparation/packing/create_shipment_on_commit'))
            {
                ...
                $shipment = Mage::helper('Orderpreparation/Shipment')->CreateShipment($order, $preparationWarehouseId, $operatorId,$weight,$telephone);
     ...
     * Print shipment PDF 
     */
    public function printCommercialInvoiceAction(){
        ...
        //// Print commercial Invoice PDF
        $order = Mage::getModel('sales/order')->load($orderId);
        Mage::helper('Orderpreparation/CommercialInvoice')->createPdf($order, $shipment);
    }
    ...
    public function printShipmentAction()
    {
		...
		{	
		   ...
		   $shipments = Mage::getResourceModel('sales/order_shipment_collection')
                ...
                ->addAttributeToFilter('entity_id', array('in' => $shipment->getEntityId()))
                ->load();
		   $pdf = Mage::getModel('sales/order_pdf_shipment')->getPdf_Gls($shipments);		
		}
		else if($_shippingMethod[0] == 'tnt')
		{	
