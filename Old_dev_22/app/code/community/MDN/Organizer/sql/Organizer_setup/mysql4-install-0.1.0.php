...
$installer->run("
	...
	CREATE TABLE IF NOT EXISTS {$this->getTable('organizer_task')} (
	...
	CREATE TABLE IF NOT EXISTS {$this->getTable('organizer_task_category')} (
	...
	CREATE TABLE IF NOT EXISTS {$this->getTable('organizer_task_origin')} (
