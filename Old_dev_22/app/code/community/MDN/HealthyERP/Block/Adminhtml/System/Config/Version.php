...
class MDN_HealthyERP_Block_Adminhtml_System_Config_Version extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    {    
        ...
        $ERP_Modules = array('AdvancedStock','BackgroundTask','HealthyERP','Orderpreparation','Organizer','Purchase','SalesOrderPlanning','Scanner');

        //dispaly the 2 versions for each modules
        foreach ($ERP_Modules as $modName){
          $realName = $prefix.$modName;

          //Get installed version from CORE RESSOURCE TABLE
