...
{
    //value spossible for $_indicator_status
    ...
    protected function checkProbe(){
      throw new Exception ('checkIndicator to implement');
    }
    ...
    public static function fixIssue($action){
      throw new Exception ('fixIndicator to implement');
    }
    ...
    /*
     * Return an array of actions to define the buttosn for the Probe
     *
     */
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
      ...
      //display data
      $html = $this->getCssModifier();
      $html .= $this->displayCurrentSituation();
      $html .= $this->displayActionsButtons();
    ...
    protected function getActionUrl($action){
      ...
      $url = Mage::helper('adminhtml')->getUrl('HealthyERP/Probe/Fix', array(
             'type' => get_class($this),
             'action' => $action));
