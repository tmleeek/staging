 ...
 * @package    Sqli_Catalog
 */
class Tatva_Catalog_Block_Product_Price_Profile2 extends Mage_Catalog_Block_Product_Price
{
	/**
	...
	public function __construct() {
		...
		$this->setData('begin_whole_price_html_tags', '<strong>');
		$this->setData('end_whole_price_html_tags', '</strong>');
		
		$this->setData('begin_price_html_tags', '');
		$this->setData('end_price_html_tags', '');
		
		$this->setData('display_tax_mod', true);
		$this->setData('begin_tax_mod_html_tags', ' <span>');
		$this->setData('end_tax_mod_html_tags', '</span>');
		
		$this->setData('begin_special_price_html_tags', '');
		$this->setData('end_special_price_html_tags', '');
	}
}
