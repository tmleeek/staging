 ...
 * @package Tatva_TransferPayment
 */
class Tatva_TransferPayment_Block_Form_Mandatadministratif extends Mage_Payment_Block_Form {
	protected function _construct() {
		parent::_construct();
		$this->setTemplate('payment/form/mandatadministratif.phtml');
	}
	...
	public function getCmsBlock() {
		$blockCode = 'paiement_mandatadministratif';
