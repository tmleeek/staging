   ...
   protected function _prepareCollection()
    {
        ...
        $collection->addExpressionAttributeToSelect('custom_margin_rate',
			'(({{price}} - {{lowest_supplier_price2}}) / {{price}} *100 )',
			array(
				'price'=>'price',
				'lowest_supplier_price2'=>'lowest_supplier_price2',
			)
        );
    ...
    protected function _prepareColumns()
    {
	  ...
	  $this->addColumn('thumbnail',
	   ...
	   $this->addColumn('entity_id',
        ...
        $this->addColumn('lowest_supplier_price2',
            array(
                'header'=> Mage::helper('catalog')->__('Lowest Supplier Price'),
                'index'=>'lowest_supplier_price2',
                'type'  => 'price',
                'currency_code' => $store->getBaseCurrency()->getCode(),
                //'renderer'  => 'Tatva_Adminhtml_Block_Catalog_Product_Renderer_Lowestprice',
        ));
        
		$this->addColumn('custom_margin_rate',
            array(
                'header'=> Mage::helper('catalog')->__('Margin Rate (%)'),
                'index'=>'custom_margin_rate',
                'type'  => 'number',
