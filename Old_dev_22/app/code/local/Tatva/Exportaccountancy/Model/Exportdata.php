...
class Tatva_Exportaccountancy_Model_Exportdata extends Mage_Core_Model_Abstract
{
    public function exportaccountancy()
    {
        ...
        $path = '/home/azboutik/public_html/exportaccounting/invoice/';
        ...
        foreach($invoices as $invoice)
        {
            ...
            if ($invoice->getShippingAmount () > 0)
            {
                ...
                if($from=="GBP")
                {
                    ...
                    //$tvaDetail [$codeTva] ['sstotht'] = ($tvaDetail [$codeTva] ['sstotht'] + $invoice->getShippingAmount ())/$divided_amt;
                    //$VAT = $invoice->getShippingAmount ()/$divided_amt;

                    //$tvaDetail [$codeTva] ['totht'] = ($tvaDetail [$codeTva] ['totht'] + $invoice->getShippingAmount ());
                    //$tvaDetail [$codeTva] ['sstotht'] = ($tvaDetail [$codeTva] ['sstotht'] + $invoice->getShippingAmount ());
            	...
            	$tvaShipping = $invoice->getShippingTaxAmount ();
           ...
           //echo "baseamount_invoiced =".$baseamount_invoiced;
           //echo "<br />";
            /*echo "<pre>";
            print_r($tvaDetail);
            echo "</pre>";
