 ...
 */
class Tatva_Shipping_Model_Carrier_Colissimocityssimo
    extends Tatva_Shipping_Model_Carrier_Abstract
    implements Mage_Shipping_Model_Carrier_Interface
{

    protected $_code = 'colissimocityssimo';
	protected $_picture = 'images/tatva/logo_colissimocityssimo.png';
	protected $_littlepicture = 'images/tatva/logo_little_colissimocityssimo.png';
    ...
    {
        return array('colissimocityssimo'=>$this->getConfigData('name'));
    }
