 ...
 */
 class Tatva_Ups_Model_Shipping_Carrier_Upssaver
     extends Tatva_Usa_Model_Shipping_Carrier_Ups
    implements Mage_Shipping_Model_Carrier_Interface
{

    protected $_code = 'upssaver';
...
XMLRequest;
       //echo "<pre>"; print_r($xmlRequest); exit;
        try {
            $ch = curl_init();
