...
class Extendware_EWPageCache_Model_Injector_Custom_Login extends Extendware_EWPageCache_Model_Injector_Abstract
{
	public function getInjection(array $params = array(), array $request = array()) {
		...
		$block->setTemplate('extendware/ewpagecache/custom/login.phtml');
