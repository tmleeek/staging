...
{if(this.regions[this.countryEl.value]){if(this.countryEl.value=='FR')
...
var i,option,region,def;if(this.regionTextEl){def=this.regionTextEl.value.toLowerCase();this.regionTextEl.value='';}
...
StateUpdater=Class.create();StateUpdater.prototype={initialize:function(country,region,region_id,zipElement,mycars)
{this.country=$(country);this.region_id=$(region_id);this.zipElement=$(zipElement);Event.observe(this.zipElement,'keyup',this.update.bind(this));},update:function()
{if(this.country.value=='FR')
{var stateval=0;var zipcode=this.zipElement.value;var zipstr=zipcode.substr(0,3);if(zipstr==971)
{stateval=mycars[0];}
else if(zipstr==972)
{stateval=mycars[1];}
else if(zipstr==973)
...
{stateval=mycars[10];}
var zipstrtwo=zipcode.substr(0,2);if(zipstrtwo=='00')
{stateval=289;}
