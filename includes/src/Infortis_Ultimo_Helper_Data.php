...
class Infortis_Ultimo_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public function getFormattedBlocks($block, $staticBlockId, $auto = true)
	{
		...
		if ($colHtml)
		{
			...
			{ //echo $colHtml_block[$i].'<br>';
			//$gridClass = ''; 
				
			   if($i == 1 && $colHtml_block[$i] == 'block_footer_column2') {$gridClass = 'grid12-4'; }
			   else if($i == 2 && $colHtml_block[$i] == 'block_footer_column3') {$gridClass = 'grid12-3'; }
			   else if($i == 3 && $colHtml_block[$i] == 'block_footer_column4') {$gridClass = 'grid12-2';}
			   //else {$gridClass = 'grid12-3';} 
