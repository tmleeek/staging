    ...
    protected function _prepareMassaction()
    {
        ...
        ;
		 ...
		 /*$this->getMassactionBlock()->addItem('delete_order', array(
             'label'=> Mage::helper('AdvancedStock')->__('Delete All1!'),
             'url'  => $this->getUrl('adminhtml/sales_order/deleteorder'),
			 'confirm' => Mage::helper('AdvancedStock')->__('Are you sure to delete the selected sales orders? Warning: invoices/shipments/credit memos associated will be also deleted!'),
        ));*/
        $this->getMassactionBlock()->addItem('pdf_order', array(
