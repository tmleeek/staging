...
class MDN_ProductReturn_Helper_CreateInvoice extends MDN_ProductReturn_Helper_CreateAbstract
{
    ...
    public function CreateInvoice(&$order)
    {
        ...
        try {
            ...
            if (!$order->canInvoice() && !Mage::getStoreConfig('productreturn/product_return/auto_create_invoice') && !(Mage::getStoreConfig('productreturn/product_return/auto_create_invoice_onlyzero') && $order->getGrandTotal() == 0)) {
