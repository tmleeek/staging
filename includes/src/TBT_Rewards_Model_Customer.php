    ...
    public function createTransferForNewCustomer()
    {
        ...
        foreach ($ruleCollection as $rule) {
            ...
            if ($is_transfer_successful) {
                ...
                Mage::getSingleton('customer/session')->addSuccess(Mage::helper('rewards')->__('You received %s for signing up!', (string)Mage::getModel('rewards/points')->set($rule)));
            } else {
                Mage::getSingleton('customer/session')->addError(Mage::helper('rewards')->__('Could not transfer points.'));
            }
        }
