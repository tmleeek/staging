...
class Minify {
     ...
     */
    static public $uploaderHoursBehind = 0;
     ...
     */
    static public $importWarning = "/* See http://code.google.com/p/minify/wiki/CommonProblems#@imports_can_appear_in_invalid_locations_in_combined_CSS_files */\n";
     ...
     * @return null
     */
    static public function setCache($cache = '', $fileLocking = true)
    {
        if (is_string($cache)) {
     ...
     * "headers" (array).
     */
    static public function serve($controller, $options = array())
    {
     ...
     * @return string
     */
    static public function combine($sources, $options = array())
    {
        $cache = self::$_cache;
        self::$_cache = null;
     ...
     * @return null
     */
    static public function setDocRoot($unsetPathInfo = false)
    {
