...
class TBT_Rewardssocial_Model_Google_PlusOne_Reference extends TBT_Rewards_Model_Transfer_Reference_Abstract
{
    const REFERENCE_TYPE_ID = 73;
    const REFERENCE_KEY = 'google_plus_one_id';
    ...
    {
        $reference_options = array(self::REFERENCE_TYPE_ID => Mage::helper('rewardssocial')->__('Google +1'));
