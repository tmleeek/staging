	...
	extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract 
{
    public function render(Varien_Object $row)
    {
    	...
    	if ($orderItemRow != null)
    	{
	    	...
	    	$reserveUrl = Mage::helper('adminhtml')->getUrl('AdvancedStock/Products/ReserveProductForOrder', array('product_id' => $productId, 'order_id' => $row->getId(), 'order_item_id' => $orderItemRow->getId()));
	    	$releaseUrl = Mage::helper('adminhtml')->getUrl('AdvancedStock/Products/ReleaseProductForOrder', array('product_id' => $productId, 'order_id' => $row->getId(), 'order_item_id' => $orderItemRow->getId()));
