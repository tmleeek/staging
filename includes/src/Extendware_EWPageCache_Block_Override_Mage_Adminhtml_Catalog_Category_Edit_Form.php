<?php
class Extendware_EWPageCache_Block_Override_Mage_Adminhtml_Catalog_Category_Edit_Form extends Extendware_EWPageCache_Block_Override_Mage_Adminhtml_Catalog_Category_Edit_Form_Bridge
{
