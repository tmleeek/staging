    ...
    public function getPdf($transfers = array()) {
        ...
        foreach ($transfers as $transfer) {
            ...
            foreach ($transfer->getProducts() as $product) {
                ...
                $page->drawText($this->TruncateTextToWidth($page, $product->getstp_product_sku(), 100), 15, $this->y, 'UTF-8');
                $page->drawText($this->TruncateTextToWidth($page, $product->getstp_product_name(), 190), 120, $this->y, 'UTF-8');
