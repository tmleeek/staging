 ...
 */
class Tatva_Adminhtml_Block_Promo_Catalog_Edit_Tab_Main extends Mage_Adminhtml_Block_Promo_Catalog_Edit_Tab_Main  implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
		...
		$fieldset->addField('promotion_type', 'select', array(
            'label'     => Mage::helper('catalogrule')->__('Type de promotion'),
            'title'     => Mage::helper('catalogrule')->__('Type de promotion'),
            'name'      => 'promotion_type',
            'required' => false,
            'options'    => array(
                '0' => 'Select',
                '1' => '1 - Promotion',
				'2' => '2 - Soldes premiere demarque',
				'3' => '3 - Soldes deuxieme demarque',
				'4' => '4 - Soldes troisieme demarque',
				'5' => '5 - Soldes quatrieme demarque',
            ),
        ));
