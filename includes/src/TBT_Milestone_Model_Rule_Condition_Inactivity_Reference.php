...
class TBT_Milestone_Model_Rule_Condition_Inactivity_Reference extends TBT_Rewards_Model_Transfer_Reference_Abstract
 {
    const REFERENCE_TYPE_ID = 603;
    const REFERENCE_KEY     = 'inactivity_milestone';
    ...
    {
        $referenceOptions = array(self::REFERENCE_TYPE_ID => Mage::helper('tbtmilestone')->__('Inactivity Milestone'));
