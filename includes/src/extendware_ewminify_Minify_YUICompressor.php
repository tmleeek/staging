...
class Minify_YUICompressor {
     ...
     * @return string 
     */
    static public function minifyCss($css, $options = array())
    {
    ...
    private static function _minify($type, $content, $options)
    {
        ...
        @chmod($tmpFile, 0777);
        exec(self::_getCmd($options, $type, $tmpFile), $output, $return);
        unlink($tmpFile);
        return implode("\n", $output);
    }
    ...
    {	
        ...
        $cmd = self::$javaExecutable . ' -Xmx512m -jar ' . escapeshellarg(self::$jarFile)
             . " --type {$type}"
