...
class MDN_Orderpreparation_Model_Pdf_PickingList extends MDN_Orderpreparation_Model_Pdf_Pdfhelper {
    ...
    public function getPdf($data = array()) {
        ...
        foreach ($products as $product) {
            ...
            $collectionText = $product['collection'];

            if (!empty($manufacturerText) && !empty($collectionText))
                $caption = $collectionText . ' - ' . $manufacturerText . ' - ' . $product['sku'];
            elseif (!empty($collectionText) && empty($manufacturerText))
                $caption = $collectionText . ' - ' . $product['sku'];
            elseif (!empty($manufacturerText) && empty($collectionText))
