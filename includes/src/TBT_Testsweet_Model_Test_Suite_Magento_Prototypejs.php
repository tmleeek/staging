    ...
    protected function generateSummary() {
        ...
        if ($content) {
            ...
            if( strpos($version, 'version 1.7') !== false) {
                ...
                $this->addWarning($this->__("Prototype JavaScript framework is version 1.6.0.3 and might have issues with IE9"), $this->__("For more help visit: https://support.sweettoothrewards.com/entries/21500253-prototype-javascript-framework-1-6-0-3"));
            } else {
