...
abstract class Gls_Unibox_Model_Label_Abstract 
{
	...
	protected function nationalDeliveryInformation($countryCode,$before) {//echo $countryCode;exit;
		...
		if($before == false) {
			if ($countryCode == "CH" || $countryCode == "GB") {
				...
				$this->data->getItemByColumnValue('tag', '871')->setValue(null);
			}
		}	
	}
	...
	protected function insertDefaults(){
        ...
        /*comment by nisha $item = new Varien_Object(); $item->setTag('8916')->setValue(null)->setPosx(42)->setPosy(52.5)->setItem( Mage::getModel('glsbox/label_item_font')->setSize(8) ); $this->data->addItem($item); $item = null;*/	//Freitext unter dem Barcode
        ...
        $item = new Varien_Object(); $item->setTag('862')->setValue(null)->setPosx(2)->setPosy(103)->setItem( Mage::getModel('glsbox/label_item_font')->setSize(10) ); $this->data->addItem($item); $item = null;
        ...
        //added by nisha
        $item = new Varien_Object(); $item->setTag('871')->setValue(null)->setPosx(23)->setPosy(123)->setItem( Mage::getModel('glsbox/label_item_font')->setSize(8) ); $this->data->addItem($item); $item = null;
      $item = new Varien_Object(); $item->setTag('8906')->setValue(null)->setPosx(23)->setPosy(126)->setItem( Mage::getModel('glsbox/label_item_font')->setSize(8) ); $this->data->addItem($item); $item = null;
