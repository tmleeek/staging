...
class Tatva_MarketPlaces_Model_Rueducommerce extends Tatva_MarketPlaces_Model_Abstract{
	...
	protected function _checkConfig(){
		if( ! $this->getConfigData( self:: GET_ORDER_URL ) || 
		    ! $this->getConfigData( self:: GET_ORDER_login ) ||
		    ! $this->getConfigData( self:: GET_ORDER_password ) )  {
