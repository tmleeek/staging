...
class Aitoc_Aitmanufacturers_Model_Aitmanufacturers extends Mage_Core_Model_Abstract
{
  ...
  public function getlistUrl($store_id,$id)
  {
     ...
     $list_colls->addFieldToFilter('manufacturer_id',$id)->addStoreFilter(Mage :: app()->getStore());
  ...
  {
     $list_url='';$list_final=''; $list_key_url_brand='';

     $list_colls= Mage::getModel('aitmanufacturers/aitmanufacturers')->getCollection();
     $list_colls->addFieldToFilter('manufacturer_id',$gid)->addStoreFilter(Mage :: app()->getStore());
     foreach($list_colls as $list)
     {
         $list_key_url=$list['url_key'];
        if($list_key_url!='')
   ...
   public function getMarqueGemaUrl($marque)
   {
      ...
      $list_colls_brand->addFieldToFilter('manufacturer_id',$marque);
  	...
  	public function getBrand($brandId) {
		$list_colls= Mage::getModel('aitmanufacturers/aitmanufacturers')->getCollection();
        $list_colls->addFieldToFilter('manufacturer_id',$brandId);
        foreach($list_colls as $list)
        {
         $brand=$list->getTitle();
        }
