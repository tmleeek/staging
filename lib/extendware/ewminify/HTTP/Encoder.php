...
class HTTP_Encoder {
     ...
     * @var bool
     */
    static public $encodeToIe6 = false;
     ...
     * @var int
     */
    static public $compressionLevel = 6;
     ...
     */
    static public function getAcceptedEncoding($allowCompress = true, $allowDeflate = true)
    {
     ...
     * @return bool success true if the content was actually compressed
     */
    static public function output($content, $compressionLevel = null)
    {
        if (null === $compressionLevel) {
            $compressionLevel = self::$compressionLevel;
        }
