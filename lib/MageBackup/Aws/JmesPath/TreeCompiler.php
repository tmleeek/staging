...
class TreeCompiler
{
    ...
    public function visit(array $ast, $fnName, $expr)
    {
        ...
        $this->write("<?php\n")
            ->write('use MageBackup\JmesPath\\TreeInterpreter as Ti;')
            ->write('use MageBackup\JmesPath\\FnDispatcher as Fn;')
            ->write('use MageBackup\JmesPath\\Utils;')
            ->write('')
