...
use MageBackup\Aws\AwsClientInterface;
use MageBackup\Aws\CommandInterface;
use MageBackup\Aws\ResultInterface;
use MageBackup\GuzzleHttp\Promise\PromiseInterface;
...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * use the {@see \MageBackup\Aws\S3\S3Client::createPresignedRequest} method and get
     ...
     * @param array  $options MageBackup\Aws\S3\BatchDelete options array.
     *
     ...
     *   function signature like `function (MageBackup\Aws\Command $command) {...}`.
     ...
     *
     * @see MageBackup\Aws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see MageBackup\Aws\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in MageBackup\Aws\S3\Transfer::__construct
     *
     * @see MageBackup\Aws\S3\Transfer for more options and customization
     */
