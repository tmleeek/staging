...
use MageBackup\Aws\Signature\SignatureTrait;
use MageBackup\Aws\Common\Enum\DateFormat;
use MageBackup\Aws\Signature\SignatureV4 as SignatureV4;
use MageBackup\Aws\Api\TimestampShape as TimestampShape;
