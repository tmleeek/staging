...
class AwsClient implements AwsClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (MageBackup\Aws\Credentials\CredentialsInterface|array|bool|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   MageBackup\Aws\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See MageBackup\Aws\Credentials\CredentialProvider for
     ...
     *   MageBackup\GuzzleHttp\TransferStats). HTTP handlers must support an
     ...
     *   is required. See MageBackup\Aws\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     *   MageBackup\Aws\ResultInterface object or rejected with an
     *   MageBackup\Aws\Exception\AwsException. A handler does not accept a next handler
     ...
     *   MageBackup\Aws\Signature\SignatureProvider for a list of built-in providers
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'MageBackup\Aws\Exception\AwsException'];
        }
        ...
        return [
            strtolower($service),
            "MageBackup\Aws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
