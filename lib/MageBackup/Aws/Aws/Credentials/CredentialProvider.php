<?php
namespace MageBackup\Aws\Credentials;

use Aws;
use MageBackup\Aws\CacheInterface;
use MageBackup\Aws\Exception\CredentialsException;
use MageBackup\GuzzleHttp\Promise;

/**
 * Credential providers are functions that accept no arguments and return a
 * promise that is fulfilled with an {@see \MageBackup\Aws\Credentials\CredentialsInterface}
 * or rejected with an {@see \MageBackup\Aws\Exception\CredentialsException}.
 *
 * <code>
 ...
 * {@see MageBackup\Aws\Credentials\CredentialProvider::chain}. This function accepts
...
class CredentialProvider
{
     ...
     * instance of MageBackup\Aws\CacheInterface. Forwards calls when no credentials found
     ...
     * @see MageBackup\Aws\Credentials\InstanceProfileProvider for $config details.
     */
