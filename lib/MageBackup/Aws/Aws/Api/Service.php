...
use MageBackup\Aws\Api\Serializer\QuerySerializer;
use MageBackup\Aws\Api\Serializer\Ec2ParamBuilder;
use MageBackup\Aws\Api\Parser\QueryParser;
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = [
            'json'      => 'MageBackup\Aws\Api\Serializer\JsonRpcSerializer',
            'query'     => 'MageBackup\Aws\Api\Serializer\QuerySerializer',
            'rest-json' => 'MageBackup\Aws\Api\Serializer\RestJsonSerializer',
            'rest-xml'  => 'MageBackup\Aws\Api\Serializer\RestXmlSerializer'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'MageBackup\Aws\Api\ErrorParser\JsonRpcErrorParser',
            'query'     => 'MageBackup\Aws\Api\ErrorParser\XmlErrorParser',
            'rest-json' => 'MageBackup\Aws\Api\ErrorParser\RestJsonErrorParser',
            'rest-xml'  => 'MageBackup\Aws\Api\ErrorParser\XmlErrorParser',
            'ec2'       => 'MageBackup\Aws\Api\ErrorParser\XmlErrorParser'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'MageBackup\Aws\Api\Parser\JsonRpcParser',
            'query'     => 'MageBackup\Aws\Api\Parser\QueryParser',
            'rest-json' => 'MageBackup\Aws\Api\Parser\RestJsonParser',
            'rest-xml'  => 'MageBackup\Aws\Api\Parser\RestXmlParser'
        ];
