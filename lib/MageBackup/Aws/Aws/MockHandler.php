 ...
 * MageBackup\Aws\ResultInterface and MageBackup\Aws\Exception\AwsException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see MageBackup\Aws\ResultInterface} or
    ...
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                ...
                throw new \InvalidArgumentException('Expected an MageBackup\Aws\ResultInterface or MageBackup\Aws\Exception\AwsException.');
            }
        }
    }
