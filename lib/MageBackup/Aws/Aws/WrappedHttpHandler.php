...
use MageBackup\Aws\Api\Parser\Exception\ParserException;
...
class WrappedHttpHandler
{
    ...
    public function __construct(
        ...
        $exceptionClass = 'MageBackup\Aws\Exception\AwsException',
        $collectStats = false
    ) {
    ...
    public function __invoke(
        ...
        if ($this->collectStats) {
            ...
            throw new \InvalidArgumentException('Providing a custom HTTP stats'
                . ' receiver to MageBackup\Aws\WrappedHttpHandler is not supported.');
        }
