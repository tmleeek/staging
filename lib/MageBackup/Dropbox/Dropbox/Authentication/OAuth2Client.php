...
use MageBackup\Dropbox\DropboxApp;
use MageBackup\Dropbox\DropboxClient;
use MageBackup\Dropbox\DropboxRequest;
...
class OAuth2Client
{
     ...
     *
     * @param \MageBackup\Dropbox\DropboxApp $app
     * @param \MageBackup\Dropbox\DropboxClient $client
     * @param \MageBackup\Dropbox\Security\RandomStringGeneratorInterface $randStrGenerator
     */
