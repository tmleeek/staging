<?php
namespace MageBackup\Dropbox\Authentication;

use MageBackup\Dropbox\Models\AccessToken;
use MageBackup\Dropbox\Exceptions\DropboxClientException;
use MageBackup\Dropbox\Store\PersistentDataStoreInterface;
use MageBackup\Dropbox\Security\RandomStringGeneratorInterface;
...
class DropboxAuthHelper
{
     ...
     *
     * @param \MageBackup\Dropbox\Authentication\OAuth2Client             $oAuth2Client
     * @param \MageBackup\Dropbox\Security\RandomStringGeneratorInterface $randomStringGenerator
     * @param \MageBackup\Dropbox\Store\PersistentDataStoreInterface      $persistentDataStore
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\AccessToken
     */
