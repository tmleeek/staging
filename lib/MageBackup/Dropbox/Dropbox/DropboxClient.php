...
use MageBackup\Dropbox\Http\Clients\DropboxHttpClientInterface;
...
class DropboxClient
{
     ...
     *
     * @var \MageBackup\Dropbox\Http\Clients\DropboxHttpClientInterface
     */
     ...
     * Get the HTTP Client
     *
     * @return \MageBackup\Dropbox\Http\Clients\DropboxHttpClientInterface $httpClient
     */
     ...
     * Set the HTTP Client
     *
     * @param \MageBackup\Dropbox\Http\Clients\DropboxHttpClientInterface $httpClient
     *
     ...
     *
     * @param  \MageBackup\Dropbox\DropboxRequest $request
     *
