...
use MageBackup\Dropbox\Models\DeletedMetadata;
use MageBackup\Dropbox\Models\File;
use MageBackup\Dropbox\Models\Account;
use MageBackup\Dropbox\Models\Thumbnail;
use MageBackup\Dropbox\Models\AccountList;
use MageBackup\Dropbox\Models\ModelFactory;
use MageBackup\Dropbox\Models\FileMetadata;
use MageBackup\Dropbox\Models\CopyReference;
use MageBackup\Dropbox\Models\FolderMetadata;
use MageBackup\Dropbox\Models\ModelCollection;
use MageBackup\Dropbox\Authentication\OAuth2Client;
use MageBackup\Dropbox\Store\PersistentDataStoreFactory;
use MageBackup\Dropbox\Authentication\DropboxAuthHelper;
use MageBackup\Dropbox\Exceptions\DropboxClientException;
use MageBackup\Dropbox\Security\RandomStringGeneratorFactory;
use MageBackup\Dropbox\Http\Clients\DropboxHttpClientFactory;
...
class Dropbox
{
     ...
     * The Dropbox App
     *
     * @var \MageBackup\Dropbox\DropboxApp
     */
    protected $app;
     ...
     * Dropbox Client
     *
     * @var \MageBackup\Dropbox\DropboxClient
     */
    protected $client;
     ...
     * OAuth2 Client
     *
     * @var \MageBackup\Dropbox\Authentication\OAuth2Client
     */
     ...
     *
     * @var \MageBackup\Dropbox\Security\RandomStringGeneratorInterface
     */
     ...
     *
     * @var \MageBackup\Dropbox\Store\PersistentDataStoreInterface
     */
     ...
     *
     * @param \MageBackup\Dropbox\DropboxApp
     ...
     *
     * @return \MageBackup\Dropbox\Authentication\DropboxAuthHelper
     */
     ...
     * Get OAuth2Client
     *
     * @return \MageBackup\Dropbox\Authentication\OAuth2Client
     */
     ...
     * Get the Dropbox App.
     *
     * @return \MageBackup\Dropbox\DropboxApp Dropbox App
     */
     ...
     * Get the Client
     *
     * @return \MageBackup\Dropbox\DropboxClient
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\FileMetadata | \MageBackup\Dropbox\Models\FolderMetadata
     ...
     *
     * @return \MageBackup\Dropbox\DropboxResponse
     */
     ...
     *
     * @return \MageBackup\Dropbox\Dropbox Dropbox Client
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\ModelInterface
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\MetadataCollection
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\ModelCollection
     */
    public function listRevisions($path, array $params = [])
    {
        ...
        //them as \MageBackup\Dropbox\Models\FileMetadata manually.
        $body = $response->getDecodedBody();
     ...
     *
     * @return \MageBackup\Dropbox\Models\SearchResults
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\FolderMetadata
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\Models\DeletedMetadata
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\Models\DeletedMetadata|\MageBackup\Dropbox\Models\FileMetadata
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\Models\DeletedMetadata|\MageBackup\Dropbox\Models\FileMetadata|\MageBackup\Dropbox\Models\FolderMetadata
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\Models\CopyReference
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\Models\TemporaryLink
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     */
     ...
     * @param $asyncJobId
     *
     * @return \MageBackup\Dropbox\Models\FileMetadata|string Status (failed|in_progress) or FileMetadata (if complete)
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\DropboxFile
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\Thumbnail
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\Models\File
     *
     * @throws \MageBackup\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \MageBackup\Dropbox\Models\Account
     */
     ...
     *
     * @return \MageBackup\Dropbox\Models\AccountList
     */
