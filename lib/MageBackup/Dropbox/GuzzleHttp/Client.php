...
use MageBackup\GuzzleHttp\Cookie\CookieJar;
use MageBackup\GuzzleHttp\Promise;
use MageBackup\GuzzleHttp\Psr7;
use MageBackup\Psr\Http\Message\UriInterface;
...
class Client implements ClientInterface
{
     ...
     *   MageBackup\GuzzleHttp\Promise\PromiseInterface that is fulfilled with a
     ...
     *
     * @see \MageBackup\GuzzleHttp\RequestOptions for a list of available request options.
     */
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        if (isset($options['json'])) {
            $jsonStr = \MageBackup\GuzzleHttp\json_encode($options['json']);
