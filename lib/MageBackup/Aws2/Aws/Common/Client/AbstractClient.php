...
use MageBackup\Aws\Common\Exception\TransferException;
...
use MageBackup\Aws\Common\Signature\SignatureListener;
use MageBackup\Aws\Common\Waiter\WaiterClassFactory;
use MageBackup\Aws\Common\Waiter\CompositeWaiterFactory;
use MageBackup\Aws\Common\Waiter\WaiterFactoryInterface;
use MageBackup\Aws\Common\Waiter\WaiterConfigFactory;
use MageBackup\Guzzle\Common\Collection;
use MageBackup\Guzzle\Http\Exception\CurlException;
use MageBackup\Guzzle\Http\QueryAggregator\DuplicateAggregator;
use MageBackup\Guzzle\Service\Client;
use MageBackup\Guzzle\Service\Description\ServiceDescriptionInterface;
...
abstract class AbstractClient extends Client implements AwsClientInterface
{
    ...
    /**
     * {@inheritdoc}
     * @throws \MageBackup\Aws\Common\Exception\TransferException
     */
