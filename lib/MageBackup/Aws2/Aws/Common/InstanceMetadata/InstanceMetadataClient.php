...
namespace MageBackup\Aws\Common\InstanceMetadata;

use MageBackup\Aws\Common\Enum\ClientOptions as Options;
use MageBackup\Aws\Common\Exception\InstanceProfileCredentialsException;
    ...
    public function getInstanceProfileCredentials()
    {
        try {
            ...
            $message = sprintf('Error retrieving credentials from the instance profile metadata server. When you are'
                ...
                . ' MageBackup\Aws\\Common\\Credentials\\CredentialsInterface object. (%s)', $e->getMessage());
