...
namespace MageBackup\Aws\Glacier\Model\MultipartUpload;

use MageBackup\Aws\Common\Enum\UaString as Ua;
use MageBackup\Aws\Common\Model\MultipartUpload\AbstractTransfer as CommonAbstractTransfer;
use MageBackup\Aws\Glacier\Model\MultipartUpload\TransferState;
use MageBackup\Guzzle\Http\EntityBody;
use MageBackup\Guzzle\Http\ReadLimitEntityBody;
