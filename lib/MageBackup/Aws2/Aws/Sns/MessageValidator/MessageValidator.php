...
namespace MageBackup\Aws\Sns\MessageValidator;

use MageBackup\Aws\Common\Exception\RequiredExtensionNotLoadedException;
use MageBackup\Aws\Sns\MessageValidator\Exception\CannotGetPublicKeyFromCertificateException;
use MageBackup\Aws\Sns\MessageValidator\Exception\CertificateFromUnrecognizedSourceException;
use MageBackup\Aws\Sns\MessageValidator\Exception\InvalidMessageSignatureException;
use MageBackup\Aws\Sns\MessageValidator\Exception\SnsMessageValidatorException;
use MageBackup\Guzzle\Http\Url;
use MageBackup\Guzzle\Http\Client;
...
class MessageValidator
{
    ...
    private static $defaultHostPattern
        = '/^sns\.[a-zA-Z0-9\-]{3,}\.amazonMageBackup\Aws\.com(\.cn)?$/';
