...
namespace MageBackup\Aws\DynamoDb\Session\LockingStrategy;

use MageBackup\Aws\Common\Enum\UaString as Ua;
use MageBackup\Aws\DynamoDb\DynamoDbClient;
use MageBackup\Aws\DynamoDb\Session\SessionHandlerConfig;
use MageBackup\Aws\DynamoDb\Exception\DynamoDbException;
use MageBackup\Aws\DynamoDb\Exception\ConditionalCheckFailedException;
