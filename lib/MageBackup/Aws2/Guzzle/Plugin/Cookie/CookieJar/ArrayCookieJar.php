...
namespace MageBackup\Guzzle\Plugin\Cookie\CookieJar;

use MageBackup\Guzzle\Plugin\Cookie\Cookie;
...
use MageBackup\Guzzle\Plugin\Cookie\Exception\InvalidCookieException;
...
class ArrayCookieJar implements CookieJarInterface, \Serializable
{
     ...
     *
     * @param \MageBackup\Guzzle\Plugin\Cookie\Cookie $cookie
     */
