...
namespace MageBackup\Guzzle\Service\Description;
...
class Operation implements OperationInterface
{
    ...
    const DEFAULT_COMMAND_CLASS = 'MageBackup\Guzzle\\Service\\Command\\OperationCommand';
     ...
     * 'MageBackup\Guzzle\\Foo\\Baz', or 'MyModelName' (to reference a model by ID).
     *
