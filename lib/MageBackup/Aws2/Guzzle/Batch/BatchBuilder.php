...
class BatchBuilder
{
    ...
    protected static $mapping = array(
        'request' => 'MageBackup\Guzzle\Batch\BatchRequestTransfer',
        'command' => 'MageBackup\Guzzle\Batch\BatchCommandTransfer'
    );
    ...
    /**
     * Configures the batch to transfer batches of requests. Associates a {@see \MageBackup\Guzzle\Http\BatchRequestTransfer}
     ...
     * {@see \MageBackup\Guzzle\Service\Command\BatchCommandTransfer} as both the transfer and divisor strategy.
     *
