...
Original Class: Mage_Core_Model_Design_Package
Original File: /data/devazb/public_html/public_html/app/code/core/Mage/Core/Model/Design/Package.php
...
class  Mage_Core_Model_Design_PackageOverriddenClass 
{
...
?><?php
if (class_exists('Extendware_EWImageOpt_Model_Override_Mage_Core_Design_Package_Bridge', false) === false) {
	abstract class Extendware_EWImageOpt_Model_Override_Mage_Core_Design_Package_Bridge extends Mage_Core_Model_Design_PackageOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWImageOpt_Model_Override_Mage_Core_Design_Package_Bridge) encountered twice');
	}
}
?><?php
class Mage_Core_Model_Design_Package extends Extendware_EWImageOpt_Model_Override_Mage_Core_Design_Package {
