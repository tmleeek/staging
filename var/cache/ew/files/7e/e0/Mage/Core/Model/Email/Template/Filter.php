...
Original Class: Mage_Core_Model_Email_Template_Filter
Original File: /data/devazb/public_html/public_html/app/code/core/Mage/Core/Model/Email/Template/Filter.php
 ...
 */
class  Mage_Core_Model_Email_Template_FilterOverriddenClass  extends Varien_Filter_Template
{
    /**
...
?><?php
if (class_exists('Extendware_EWImageOpt_Model_Override_Mage_Core_Email_Template_Filter_Bridge', false) === false) {
	abstract class Extendware_EWImageOpt_Model_Override_Mage_Core_Email_Template_Filter_Bridge extends Mage_Core_Model_Email_Template_FilterOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWImageOpt_Model_Override_Mage_Core_Email_Template_Filter_Bridge) encountered twice');
	}
}
?><?php
class Mage_Core_Model_Email_Template_Filter extends Extendware_EWImageOpt_Model_Override_Mage_Core_Email_Template_Filter {
