...
Original Class: Mage_Adminhtml_Block_Page_Menu
Original File: /data/devazb/public_html/public_html/app/code/core/Mage/Adminhtml/Block/Page/Menu.php
 ...
 */
class  Mage_Adminhtml_Block_Page_MenuOverriddenClass  extends Mage_Adminhtml_Block_Template
{
...
?><?php
if (class_exists('Extendware_EWCore_Block_Override_Mage_Adminhtml_Page_Menu_Bridge', false) === false) {
	abstract class Extendware_EWCore_Block_Override_Mage_Adminhtml_Page_Menu_Bridge extends Mage_Adminhtml_Block_Page_MenuOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWCore_Block_Override_Mage_Adminhtml_Page_Menu_Bridge) encountered twice');
	}
}
?><?php
class Mage_Adminhtml_Block_Page_Menu extends Extendware_EWCore_Block_Override_Mage_Adminhtml_Page_Menu {
