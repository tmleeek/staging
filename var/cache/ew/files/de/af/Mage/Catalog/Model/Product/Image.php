...
Original Class: Mage_Catalog_Model_Product_Image
Original File: /data/devazb/public_html/public_html/app/code/core/Mage/Catalog/Model/Product/Image.php
 ...
 */
class  Mage_Catalog_Model_Product_ImageOverriddenClass  extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
...
?><?php
if (class_exists('Extendware_EWImageOpt_Model_Override_Mage_Catalog_Product_Image_Bridge', false) === false) {
	abstract class Extendware_EWImageOpt_Model_Override_Mage_Catalog_Product_Image_Bridge extends Mage_Catalog_Model_Product_ImageOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWImageOpt_Model_Override_Mage_Catalog_Product_Image_Bridge) encountered twice');
	}
}
?><?php
class Mage_Catalog_Model_Product_Image extends Extendware_EWImageOpt_Model_Override_Mage_Catalog_Product_Image {
