...
Original Class: Mage_Catalog_Helper_Image
Original File: /data/devazb/public_html/public_html/app/code/core/Mage/Catalog/Helper/Image.php
 ...
 */
class  Mage_Catalog_Helper_ImageOverriddenClass  extends Mage_Core_Helper_Abstract
{
    /**
     * Current model
     *
...
?><?php
if (class_exists('Extendware_EWImageOpt_Helper_Override_Mage_Image_Bridge', false) === false) {
	abstract class Extendware_EWImageOpt_Helper_Override_Mage_Image_Bridge extends Mage_Catalog_Helper_ImageOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWImageOpt_Helper_Override_Mage_Image_Bridge) encountered twice');
	}
}
?><?php
class Mage_Catalog_Helper_Image extends Extendware_EWImageOpt_Helper_Override_Mage_Image {
