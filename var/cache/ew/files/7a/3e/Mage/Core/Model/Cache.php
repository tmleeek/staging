...
Original Class: Mage_Core_Model_Cache
Original File: /data/devazb/public_html/public_html/app/code/core/Mage/Core/Model/Cache.php
 ...
 */
class  Mage_Core_Model_CacheOverriddenClass 
{
    /**
     * Cache settings
     */
...
?><?php
if (class_exists('Extendware_EWCacheBackend_Model_Override_Mage_Core_Cache_Bridge', false) === false) {
	abstract class Extendware_EWCacheBackend_Model_Override_Mage_Core_Cache_Bridge extends Mage_Core_Model_CacheOverriddenClass  {

	}
} else {
	if (class_exists('Mage', false) === true) {
		Mage::log('Bridge class (Extendware_EWCacheBackend_Model_Override_Mage_Core_Cache_Bridge) encountered twice');
	}
}
?><?php
class Mage_Core_Model_Cache extends Extendware_EWCacheBackend_Model_Override_Mage_Core_Cache {
