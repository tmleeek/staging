...
class Mage_Catalog_Model_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
        ...
        if($this->_requestVar=='gamme_collection_new')
        {
           $filter=$this->getCustomFilterId($filter);
        }
        elseif($this->_requestVar=='manufacturer')
        {
           $filter=$this->getCustomFilterId($filter);
        }
    ...
    protected function _getItemsData()
    {
     ...
     public function getCustomFilterId($key)
   {  //echo "hi";
     $id='';
     //echo $key;
     $list_colls= Mage::getModel('aitmanufacturers/aitmanufacturers')->getCollection();
     $list_colls->addFieldToFilter('url_key',$key);
    // echo  $list_colls->getSelect();
     //echo "<pre>"; print_r($list_colls->getData());
     foreach($list_colls as $list)
     {
        $id=$list->getManufacturerId();
     }
     return $id;
   }
}
