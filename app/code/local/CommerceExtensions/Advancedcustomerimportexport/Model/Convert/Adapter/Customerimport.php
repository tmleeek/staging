    ...
    extends Mage_Eav_Model_Convert_Adapter_Entity
{
    ...
    public function __construct()
    {
		...
		$this->_billingFields[] = 'billing_digital_to_access';
		$this->_billingFields[] = 'billing_entry_phone';
		
		$this->_shippingFields[] = 'shipping_vat_id';
		$this->_shippingFields[] = 'shipping_digital_to_access';
		$this->_shippingFields[] = 'shipping_entry_phone';
...
//                        }
    ...
    public function saveRow($importData)
    {
        ...
        if(isset($importData['increment_id'])) {
           $customer->setIncrementId ($importData['increment_id']);
        }
        if($this->getBatchParams('update_customer_password') == "true") { 
            if (isset($importData['password'])) {
                #echo "HERE: " . $importData['password'];
        ...
        if ($importBillingAddress) {
			...
			//$billingAddress->setVatID($importData['billing_tax_id']);
        ...
        if ($importShippingAddress) { 
			...
			//$shippingAddress->setDataUsingMethod('vat_id', 'hello');
