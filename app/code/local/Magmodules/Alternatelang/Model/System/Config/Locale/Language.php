...
class Magmodules_Alternatelang_Model_System_Config_Locale_Language extends Mage_Core_Model_Config_Data {
	...
	public function afterLoad() 
	{
		if($store =  Mage::app()->getRequest()->getParam('store')) {    	
			...
			$language = Mage::helper('alternatelang')->__('-- please select store scope --');	
		}
