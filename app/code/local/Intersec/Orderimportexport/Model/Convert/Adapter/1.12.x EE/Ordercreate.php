...
//                }
    ...
    public function setShippingMethod($method)
    {
		if($method == "flatrate_flatrate") {
        	$this->getShippingAddress()->setShippingMethod('multipletablerates_bestway_60');
		} else {
	...
	*/
    public function setPaymentData($data)
    {
        ...
        if ($data['method'] == 'purchaseorder' || $data['method'] == 'authorizenet' || $data['method'] == 'authorizecimsoap') {
    ...
    public function createOrder()
    {
		...
		$service = $this->getServiceQuoteModel($quote);
