...
class Tatva_Cibleweb_Model_Paarlyxml extends Mage_Core_Model_Abstract {
...
public function xml_escape($s)
{
	...
	public function saveCsvFileLocal( $datas ){
		...
		if( ! $this->createDir( $root )){
		 ...
		 $pathFile = $_SERVER['DOCUMENT_ROOT'].'paarly/'.'paarly.xml';
         try{
...
//echo $datas[$keys]['unique_id'].'=='.$pathFile.'<br>';
		     ...
		     $pathFile = $_SERVER['DOCUMENT_ROOT'].DS.'paarly'.DS.'paarly.xml';
             
             $pathFile =  Mage::getBaseDir().DS.'paarly'.DS.'paarly.xml';
