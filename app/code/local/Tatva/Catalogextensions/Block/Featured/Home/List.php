...
class Tatva_Catalogextensions_Block_Featured_Home_List extends Tatva_Catalogextensions_Block_Featured_List
{
        ...
        public function _getHomeProductCollection()
      {
        parent::__construct();
        $storeId    = Mage::app()->getStore()->getId();
        $products = Mage::getModel('catalog/product')->getCollection()
        ...
        if(Mage::getStoreConfig('featured/config2/max_product'))
        {     echo Mage::getStoreConfig('featured/config2/max_product');
            $products->setPageSize(Mage::getStoreConfig('featured/config2/max_product'));
        }
