    ...
    public function exportaccountAction()
    {
        ...
        for($i=0;$i<count($invoicesIds);$i++)
        {
            ...
            if($from=="GBP")
            {
               ...
               $value =  '"'.$invoiceDate .'","VE","0","'.$code.'","'.$customer_name.'",'.$gt.',"","'.$invoice->getIncrementId().'","'.$order_inc_id.'"';
            }
            elseif($from == "USD")
            {
                $amt1 = $order->getGrandTotal()*$divided_amt;
            ...
            {
                $value =  '"'.$invoiceDate .'","VE","0","'.$code.'","'.$customer_name.'","'.number_format($order->getGrandTotal(),2).'","","'.$invoice->getIncrementId().'","'.$order_inc_id.'"';
            }
            ...
            foreach ($tvaDetail as $tvaItem )
            {
                ...
                {
                    $value =  '"'.$invoiceDate .'","VE","0","'.$code_subtotal.'","'.$customer_name.'","","'.number_format($tvaItem['sstotht'],2).'","'.$invoice->getIncrementId().'","'.$order_inc_id.'"';
                    @fwrite($fp, $value."\n");
                }

                if($tvaItem['port']!='0.0000')
                {
                    $value =  '"'.$invoiceDate .'","VE","0","'.$code_shipping.'","'.$customer_name.'","","'.number_format($tvaItem['port'],2).'","'.$invoice->getIncrementId().'","'.$order_inc_id.'"';
                    @fwrite($fp, $value."\n");
                }

                if($tvaItem['tva']!='0.0000')
                {
                    $value =  '"'.$invoiceDate .'","VE","0","'.$code_vat.'","'.$customer_name.'","","'.number_format($invoice->getBaseTaxAmount(),2).'","'.$invoice->getIncrementId().'","'.$order_inc_id.'"';
                    @fwrite($fp, $value."\n");
                }
                ...
                {
                    $value =  '"'.$invoiceDate .'","VE","0","'.$code_vat1.'","'.$customer_name.'","","'.number_format($tvaItem['dee'],2).'","'.$invoice->getIncrementId().'","'.$order_inc_id.'"';
                    @fwrite($fp, $value."\n");
                }
                if($tvaItem['rem']!='0.0000')
                {
                    $value =  '"'.$invoiceDate .'","VE","0","'.$code_rebate.'","'.$customer_name.'","'.number_format($tvaItem['rem'],2).'","","'.$invoice->getIncrementId().'","'.$order_inc_id.'"';
                    @fwrite($fp, $value."\n");
                }
