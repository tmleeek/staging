...
class Tatva_MarketPlaces_Model_Status_Fbdinvoice extends Mage_Core_Model_Abstract
{
	...
	public function execute()
    {
		...
		try
        {
            //@mail("sagarshahitprofessional@gmail.com","FBD order update","2.invoice order checked");
            ...
            foreach($orderCollection as $order)
            {
                ...
                {
                    //@mail("sagarshahitprofessional@gmail.com","FBD Invoice","1.".$order->getIncrementId()."Order found");
                    ...
                    //@mail("sagarshahitprofessional@gmail.com","FBD Invoice","2.".$order->getIncrementId()."-".$Fbd_order."Order update Completed");
                    /*echo "<pre>";
                    print_r($xml);
                    echo "</pre>";
                    echo "<br/><br/>";
	...
	protected function _getOrderCollection()
    {
		if(!$this->_collectionOrders)
        {
			...
			$this->_collectionOrders = Mage::getModel('sales/order')->getCollection()
                            ...
                            //->addAttributeToFilter( 'entity_id' , array( 'eq'=> array( '134080' ) ) )
