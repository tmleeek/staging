                ...
                if(!empty($order))
                {
                    try
                    {
                      ...
                      /*echo "<pre>";
                        ...
                        $total_subtotal = $totalTTC -  $shippingAmount;

        				//- Methode de livraison
        				$this->addShippingMethod(utf8_encode( (string)$infoCommande->transport->nom ),$total_subtotal);
                        ...
                        /*echo "<pre>";
                            ...
                            echo "</pre>";
                            exit;*/
        				    Mage::log ( 'DEBUT Traitement Produit =  '. $item->attributes()->merchantOfferId , Zend_log::INFO, $this->getLogFile() );
        			        ...
        			        $collection->addFieldToFilter('lengow_id', $item->attributes()->merchantOfferId);


                            $Product_data = $collection->getData();
                            ...
                            {
                                  $product_id = $Product_data[0]['entity_id'];
                            }
