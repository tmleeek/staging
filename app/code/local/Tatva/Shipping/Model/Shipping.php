...
class Tatva_Shipping_Model_Shipping extends Mage_Shipping_Model_Shipping
{
    /**
     * Store address
     */
    ...
    public function requestToShipment(Mage_Sales_Model_Order_Shipment $orderShipment)
    {
        ...
        //$request->setShipperSenderParcelRef($order->getEntityId());
        ...
        $request->setShipperContactCompanyName($originStreet2);
        ...
        $request->setShipperAddressStreet(trim($originStreet1));

        $request->setShipperAddressStreet1($originStreet1);

        //$request->setShipperAddressStreet2($originStreet2);
        $request->setShipperAddressStreet2();
        
        //$request->setShipperDoorCode1();
        ...
        $request->setRecipientContactMobileNumber($mobile_phone);
        ...
        $request->setRecipientAddressStreet3($address->getStreet3());

        $request->setRecipientDoorCode1($address->getStreet4());
        $request->setRecipientIntercom("123456");
        $request->setRecipientLanguage("FR");
        ...
        //echo "post weight =".$weight = $_POST['weight'];
        //echo "<br /><br />";
        if(empty($weight))
            $weight = $order->getWeight();


         //echo "Final weight =".$weight;
        //$parcelCount = $_POST['parcel_count'];
