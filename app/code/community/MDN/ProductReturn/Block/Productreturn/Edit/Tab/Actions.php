...
class MDN_ProductReturn_Block_Productreturn_Edit_Tab_Actions extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function getExchangeHtml($product)
    {
        ...
        $spanContent .= '<br>' . $this->__('Adjust price') . ' : <input type="textbox" size="5" id="exhange_price_adjustment_' . $product->getrp_id() . '" name="exhange_price_adjustment_' . $product->getrp_id() . '" value="+0" onkeyup="displayAjustPriceTextHelper(' . $product->getrp_id() . ');">';
