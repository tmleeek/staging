...
class MDN_DropShipping_Block_Tabs_PendingPriceResponse extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct() {

        parent::__construct();
        $this->setId('dropShippPendingPriceResponse');
    ...
    protected function _prepareCollection() {
        $dropShippingOrderIds = mage::helper('DropShipping')->getPendingPriceResponseOrderIds();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('content', array(
            ...
            'sortable' => false,
            'filter' => false,
            'dropship_status_restriction' => array(MDN_DropShipping_Helper_Data::STATUS_DROPSHIP_PRICE_REQUEST_SENT),
            'div_prefix' => 'pendingpriceresponse_content_'
        ));


        $this->addColumn('dropshippable_action', array(
            'header' => Mage::helper('AdvancedStock')->__('Action'),
            'renderer' => 'MDN_DropShipping_Block_Widget_Grid_Column_Renderer_PendingPriceResponseAction',
            'sortable' => false,
            'filter' => false,
            'align' => 'center'
        ));
    ...
    public function getGridUrl() {
        return $this->getUrl('*/*/ajaxPendingPriceResponseGrid');
    }
