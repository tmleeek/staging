...
class MDN_AdvancedStock_Model_CatalogInventory_Stock_Item extends Mage_CatalogInventory_Model_Stock_Item {
    ...
    public function checkQty($qty)
    {
		...
		/*$productAvailabilityStatus = Mage::helper('SalesOrderPlanning/ProductAvailabilityStatus')->getForOneProduct($product_id);
		if ($productAvailabilityStatus->getId())
			$qtyAvailableForSales = $productAvailabilityStatus->getPaAvailableQty();*/
			
		//$qtyAvailableForSales = $this->getAvailableQty();

        /*echo "qty =".$qty;
        echo "<br />";
        echo "qtyAvailableForSales =".$qtyAvailableForSales;
        echo "<br /><br /><br />";*/
