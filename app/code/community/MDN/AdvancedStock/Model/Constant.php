...
class MDN_AdvancedStock_Model_Constant extends Mage_Core_Model_Abstract
{
	...
	private $_ProductGammeAttributeCode = null;
	...
	public function GetProductGammeCollectionAttributeId()
	{
		
              //default value is manufacturer attribute is not overridden by the configuration option
              $this->_ProductGammeAttributeId = mage::getModel('eav/entity_attribute')->loadByCode('catalog_product', 'gamme_collection_new ')->getId();
            
		return $this->_ProductGammeAttributeId;
	}
	...
	public function GetProductGammeCollectionAttributeCode()
	{
		if ($this->_ProductGammeAttributeCode == null)
		{
            $gammeAttributeId = $this->GetProductGammeCollectionAttributeId();

            if($gammeAttributeId>0){
              $entity = Mage::getModel('eav/entity_attribute')->load($gammeAttributeId);              
              $this->_ProductGammeAttributeCode = $entity->getattribute_code();
            }
		}
		return $this->_ProductGammeAttributeCode;
	}
