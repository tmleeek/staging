...
class MDN_AdvancedStock_Block_Transfer_NotFullyApplicable extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    {
        return $this->getUrl('AdvancedStock/Transfer/Edit', array('st_id' => $this->getTransfer()->getId()));
    }

    public function getForceUrl()
    {
        return $this->getUrl('AdvancedStock/Transfer/Apply', array('st_id' => $this->getTransfer()->getId(), 'force_transfer' => '1'));
    }
