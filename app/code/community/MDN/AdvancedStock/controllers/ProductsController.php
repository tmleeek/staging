...
class MDN_AdvancedStock_ProductsController extends Mage_Adminhtml_Controller_Action {
    ...
    public function EditAction() {
        ...
        $productId = $this->getRequest()->getParam('product_id'); //echo 'tets=='.$productId;
        $product = Mage::getModel('catalog/product')->load($productId); //echo 'test123=='.$product->getId();
        if (!$product->getId())
        {
            Mage::getSingleton('adminhtml/session')->addError($this->__('This product does not exist123 !'));
    ...
    public function SaveAction() {
      ...
      /*echo "<pre>";
        ...
        try {
            ...
            Mage::getSingleton('adminhtml/session')->addError($this->__('An error occured : ') . $ex->getMessage().$ex->getTraceAsString());
        }
