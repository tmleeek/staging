	...
	******************************************************************************************************************************/
	...
	public function setShippingInformation($order, $quoteMode = false)
	{
		...
		if (Mage::getStoreConfig('planning/shipping/avoid_holy_days') == 1)
		{
            ...
            $type=0;
            if(($carrier=='colissimo_colissimo') || ($carrier=='colissimoappointment_colissimoappointment') || ($carrier=='colissimolocalstore_colissimolocalstore') || ($carrier=='colissimopostoffice_colissimopostoffice') || ($carrier=='colissimocityssimo_colissimocityssimo') || ($carrier=='tnt_JD') || ($carrier=='tnt_J') ||($carrier=='tnt_JZ'))
             {
                $type=1;
             }
            /* end --mauli */
