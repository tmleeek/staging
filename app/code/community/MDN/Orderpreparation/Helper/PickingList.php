...
class MDN_Orderpreparation_Helper_PickingList extends Mage_Core_Helper_Abstract {
    ...
    public function getProductsSummaryFromOrderIds(array $orderIds, $warehouseId) {
        ...
        $collectionAttributeExists = false;
        $collectionCode = mage::getModel('AdvancedStock/Constant')->GetProductGammeCollectionAttributeCode();
        if($collectionCode && $collectionCode == 'gamme_collection_new'){
          $collectionAttributeExists = true;
        }
        foreach ($collection as $order) {
            ...
            foreach ($order->getAllItems() as $orderItem) {
                ...
                if (isset($products[$product_id])){
                    ...
                    if($collectionAttributeExists){
                      $product->setcollection($product->getAttributeText('gamme_collection_new'));
                    }
                }
            }
        }
