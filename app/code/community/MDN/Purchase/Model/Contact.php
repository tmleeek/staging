	...
	*/
	...
	{		
        ...
        if($entity){
            ...
            {
                case 'manufacturer':
                    $text .= '<a href="'.Mage::helper('adminhtml')->getUrl('Purchase/Manufacturers/Edit/').'man_id/'.$entity->getman_id().'" target="_blank">';
                    $text .= Mage::helper('purchase')->__('Manufacturer').' - '.$entity->getman_name();
                    break;
                case 'supplier':
                    $text .= '<a href="'.Mage::helper('adminhtml')->getUrl('Purchase/Suppliers/Edit/').'sup_id/'.$entity->getsup_id().'" target="_blank">';
