...
class MDN_Purchase_OrdersController extends Mage_Adminhtml_Controller_Action {
        ...
        try {
            ...
            if ($Notify == 1) {
                ...
                if($backmessage !== false){
                    ...
                    Mage::getSingleton('adminhtml/session')->addError($this->__('No supplier email defined : Notification aborded'));
                }
    ...
    public function PrintDeliveryNoteAction()
    {
        ...
        {
           Mage::getSingleton('adminhtml/session')->addError($ex->getMessage());
           $this->_redirect('Purchase/Orders/Edit/', array('po_num' => $poId));
        }
