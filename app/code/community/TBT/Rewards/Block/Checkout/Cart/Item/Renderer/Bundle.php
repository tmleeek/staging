...
class TBT_Rewards_Block_Checkout_Cart_Item_Renderer_Bundle extends TBT_Rewards_Block_Checkout_Cart_Item_Renderer {
	...
	protected function _getSelectionFinalPrice($selectionProduct) {
		...
		return $bundleProduct->getPriceModel ()->getSelectionFinalPrice ( $bundleProduct, $selectionProduct, $this->getQty (), $this->_getSelectionQty ( $selectionProduct->getSelectionId () ) );
	}
	...
	public function getOptionList() {
		...
		return array_merge (parent::getOptionList () );
	}
