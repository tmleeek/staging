...
class TBT_Rewards_Block_Checkout_Cart extends TBT_Rewards_Block_Checkout_Abstract {
	...
	protected function _construct() {
		...
		// Hack to make sure the slider will still display after you reload the admin order page.
		if (Mage::app()->getStore()->isAdmin()) {
			$quote = $this->_getRewardsSess()->getQuote();
			$quote->collectTotals();
	...
	public function showCartRedeemBox() {
		$storeId = $this->_getRewardsSess()->getQuote()->getStoreId();
