 ...
 */
class TBT_Rewards_Model_Tag_Validator extends TBT_Rewards_Model_Special_Validator {
	...
	/**
	 * Returns an array outlining the number of points they will receive for making a tag
	 *
	 * @return array
	 */
	public function getPredictPoints() {
		Varien_Profiler::start ( "TBT_Rewards:: Predict Tag Points" );
		$ruleCollection = $this->getApplicableRulesOnTag ();
		$predict_array = array ();
