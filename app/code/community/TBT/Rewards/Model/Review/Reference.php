 ...
 */
class TBT_Rewards_Model_Review_Reference extends TBT_Rewards_Model_Transfer_Reference_Abstract {
	const REFERENCE_TYPE_ID = 2;
	...
	public function getReferenceOptions() {
		$reference_options = array (self::REFERENCE_TYPE_ID => Mage::helper ( 'rewards' )->__ ( 'Review' ) );
	...
	public function loadTransferId($transfer) {
		...
		$transfer->setReferenceType ( TBT_Rewards_Model_Review_Reference::REFERENCE_TYPE_ID );
		$transfer->setReferenceId ( $id );
		$transfer->setData ( 'review_id', $id );
