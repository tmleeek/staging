...
class TBT_Rewardssocial_Model_Purchase_Share_Twitter_Reference extends TBT_Rewards_Model_Transfer_Reference_Abstract
{
    const REFERENCE_TYPE_ID = 83;
    ...
    {
        $reference_options = array(self::REFERENCE_TYPE_ID => Mage::helper('rewardssocial')->__('Purchase Share on Twitter'));
