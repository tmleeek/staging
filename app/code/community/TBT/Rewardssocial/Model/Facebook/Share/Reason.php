...
class TBT_Rewardssocial_Model_Facebook_Share_Reason extends TBT_Rewards_Model_Transfer_Reason_Abstract
{

    const REASON_TYPE_ID = 36;
    ...
    {
        return array(self::REASON_TYPE_ID => Mage::helper('rewardssocial')->__('Facebook Product Share'));
    }
