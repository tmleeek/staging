...
class Ess_M2ePro_Adminhtml_Common_Amazon_Template_ProductTaxCodeController
    extends Ess_M2ePro_Controller_Adminhtml_Common_MainController
{
    ...
    protected function _initAction()
    {
        ...
        $this->getLayout()->getBlock('head')
            ...
            ->addJs('M2ePro/Common/Amazon/Template/ProductTaxCodeHandler.js');
...
//                                    ->getDocumentationUrl(null, null, 'TODO LINK');
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
             ->_addContent(
                 $this->getLayout()->createBlock('M2ePro/adminhtml_common_amazon_template_productTaxCode_edit')
             )
             ->renderLayout();
    }
    ...
    public function viewPopupAction()
    {
        ...
        $mainBlock = $this->loadLayout()->getLayout()
            ->createBlock('M2ePro/adminhtml_common_amazon_listing_template_productTaxCode');
    ...
    public function viewGridAction()
    {
        ...
        $grid = $this->loadLayout()->getLayout()
            ->createBlock('M2ePro/adminhtml_common_amazon_listing_template_productTaxCode_grid');
