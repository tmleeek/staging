    ...
    extends Ess_M2ePro_Controller_Adminhtml_Common_MainController
{
    ...
    {
        $components = Mage::helper('M2ePro')->jsonDecode($this->getRequest()->getParam('components'));
    ...
    public function runAllEnabledNowAction()
    {
        ...
        $dispatcher->setAllowedComponents(Mage::helper('M2ePro')->jsonDecode(
            $this->getRequest()->getParam('components'))
        );
    ...
    public function synchCheckProcessingNowAction()
    {
        ...
        $buyProcessing = Mage::getModel('M2ePro/Lock_Item')->getCollection()
