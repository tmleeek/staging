    ...
    **/
    ...
    public function isShowMultiCurrencyNotification()
    {
        ...
        $configValue = Mage::helper('M2ePro/Module')->getCacheConfig()->getGroupValue(
            "/view/ebay/template/selling_format/multi_currency_marketplace_{$marketplaceId}/", 'notification_shown'
        );
        ...
        Mage::helper('M2ePro/Module')->getCacheConfig()->setGroupValue(
            "/view/ebay/template/selling_format/multi_currency_marketplace_{$marketplaceId}/", 'notification_shown', 1
        );
