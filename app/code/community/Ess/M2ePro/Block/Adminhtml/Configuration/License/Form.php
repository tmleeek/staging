...
class Ess_M2ePro_Block_Adminhtml_Configuration_License_Form extends Ess_M2ePro_Block_Adminhtml_Configuration_Abstract
{
    ...
    protected function _beforeToHtml()
    {
        ...
        // ---------------------------------------
        $data = array(
            'label'   => Mage::helper('M2ePro')->__('Create New License'),
            'onclick' => 'LicenseHandlerObj.newLicenseKeyPopup();',
            'class'   => 'new_license'
        );
        $buttonBlock = $this->getLayout()->createBlock('adminhtml/widget_button')->setData($data);
        ...
        $data = array(
            'label' => Mage::helper('M2ePro')->__('Confirm'),
            'onclick' => 'LicenseHandlerObj.newLicenseKey();',
            'class' => 'create_license'
        );
        $buttonBlock = $this->getLayout()->createBlock('adminhtml/widget_button')->setData($data);
        $this->setChild('create_license',$buttonBlock);
        // ---------------------------------------
