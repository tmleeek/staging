...
class Ess_M2ePro_Block_Adminhtml_Common_Amazon_Listing_Template_ProductTaxCode_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $templateEditUrl = $this->getUrl('*/adminhtml_common_amazon_template_productTaxCode/edit', array(
            'id' => $row->getData('id')
        ));
...
HTML;
    ...
    {
        return $this->getUrl('*/adminhtml_common_amazon_template_productTaxCode/viewGrid', array(
            '_current' => true
        ));
    }
...
HTML;
    ...
    {
        return $this->getUrl('*/adminhtml_common_amazon_template_productTaxCode/new');
    }
