...
class Ess_M2ePro_Block_Adminhtml_Common_Amazon_Listing_Search_M2ePro_Grid
    extends Ess_M2ePro_Block_Adminhtml_Common_Amazon_Listing_Search_Grid
{
    //########################################
    ...
    public function callbackColumnProductTitle($value, $row, $column, $isExport)
    {
        ...
        $listingUrl = $this->getUrl('*/adminhtml_common_amazon_listing/view',
...
HTML;
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $manageUrl = $this->getUrl('*/adminhtml_common_amazon_listing/view/',array(
