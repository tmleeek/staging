    ...
    extends Ess_M2ePro_Block_Adminhtml_Common_Template_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        // ---------------------------------------
        $collectionShippingTemplate = Mage::getModel('M2ePro/Amazon_Template_ShippingTemplate')->getCollection();
        $collectionShippingTemplate->getSelect()->reset(Varien_Db_Select::COLUMNS);
...
//        echo $resultCollection->getSelectSql(true); exit;
    ...
    protected function _prepareColumns()
    {
        ...
        $options = array(
            ...
            self::TEMPLATE_SHIPPING_TEMPLATE => Mage::helper('M2ePro')->__('Shipping Template'),
