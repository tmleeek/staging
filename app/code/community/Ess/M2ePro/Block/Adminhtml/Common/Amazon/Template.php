    ...
    protected function getAddButtonJavascript()
    {
            ...
            'items'            => array(
                ...
                array(
                    'url'   => $this->getUrl(
                        ...
                        array(
                            'channel' => $this->nick,
                            'type' => Ess_M2ePro_Block_Adminhtml_Common_Amazon_Template_Grid::TEMPLATE_SHIPPING_TEMPLATE
                        )
                    ),
                    'label' => Mage::helper('M2ePro')->__('Shipping Template')
                ),
                array(
                    'url'   => $this->getUrl(
                        '*/adminhtml_common_template/new',
        ...
        $data['items'][] = array(
            'url'   => $this->getUrl(
                ...
                array(
                    'channel' => $this->nick,
                    'type' => Ess_M2ePro_Block_Adminhtml_Common_Amazon_Template_Grid::TEMPLATE_PRODUCT_TAX_CODE
                )
            ),
