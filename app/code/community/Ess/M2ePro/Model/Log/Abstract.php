...
class Ess_M2ePro_Model_Log_Abstract extends Ess_M2ePro_Model_Abstract
{
    ...
    public function getStatusByActionId($actionId)
    {
        ...
        if (empty($logRecords)) {
            throw new Ess_M2ePro_Model_Exception('Logs action id does not exists.');
        }

        $typesStatusesMap = array(
            self::TYPE_NOTICE  => Ess_M2ePro_Helper_Data::STATUS_SUCCESS,
            self::TYPE_SUCCESS => Ess_M2ePro_Helper_Data::STATUS_SUCCESS,
            self::TYPE_WARNING => Ess_M2ePro_Helper_Data::STATUS_WARNING,
            self::TYPE_ERROR   => Ess_M2ePro_Helper_Data::STATUS_ERROR,
        );
        ...
        return Mage::helper('M2ePro')->getMainStatus($statuses);
    }
