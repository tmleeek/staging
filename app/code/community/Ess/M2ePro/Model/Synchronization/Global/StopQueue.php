...
final class Ess_M2ePro_Model_Synchronization_Global_StopQueue
    extends Ess_M2ePro_Model_Synchronization_Global_Abstract
{
    ...
    {
        return Ess_M2ePro_Model_Synchronization_Task_Global_Abstract::STOP_QUEUE;
    }
    ...
    private function sendAccountMarketplaceRequests($component, $accountMarketplaceItems)
    {
        try {
            ...
            $dispatcher = Mage::getModel('M2ePro/'.ucwords($component).'_Connector_Dispatcher');
