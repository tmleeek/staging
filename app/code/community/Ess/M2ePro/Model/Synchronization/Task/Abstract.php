...
abstract class Ess_M2ePro_Model_Synchronization_Task_Abstract
{
    ...
    protected function makeTask($taskPath)
    {
        ...
        $task = Mage::getModel('M2ePro/'.$this->buildTaskPath($taskPath));
    ...
    {
        return 'Synchronization_'.$taskPath;
    }
     ...
     */
    public function setParentLockItem(Ess_M2ePro_Model_Synchronization_Lock_Item_Manager $object)
    {
