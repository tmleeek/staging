...
class Ess_M2ePro_Model_Synchronization_Templates_ProductChanges_Manager
{
    ...
    {
        return $this->getListingProducts($attributes, $withStoreFilter, 'getChangedItems');
    }
    ...
    {
        return $this->getListingProducts($attributes, $withStoreFilter, 'getChangedItemsByListingProduct');
    }
    ...
    {
        return $this->getListingProducts($attributes, $withStoreFilter, 'getChangedItemsByVariationOption');
    }
    ...
    {
        $args = func_get_args();
        $cacheKey = md5(Mage::helper('M2ePro')->jsonEncode($args));
        ...
        /** @var Ess_M2ePro_Model_Listing_Product[] $listingProducts */
