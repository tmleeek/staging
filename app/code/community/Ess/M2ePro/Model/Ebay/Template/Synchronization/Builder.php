    ...
    extends Ess_M2ePro_Model_Ebay_Template_Builder_Abstract
{
    ...
    protected function prepareData(array &$data)
    {
        ...
        $defaultData['schedule_interval_settings'] = Mage::helper('M2ePro')->jsonDecode(
            $defaultData['schedule_interval_settings']
        );
        $defaultData['schedule_week_settings'] = Mage::helper('M2ePro')->jsonDecode(
            $defaultData['schedule_week_settings']
        );
    ...
    private function prepareScheduleData(array $data)
    {
        ...
        $prepared['schedule_interval_settings'] = Mage::helper('M2ePro')->jsonEncode($intervalSettings);
        ...
        $prepared['schedule_week_settings'] = Mage::helper('M2ePro')->jsonEncode($weekSettings);
