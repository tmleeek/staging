...
final class Ess_M2ePro_Model_Ebay_Synchronization_Templates_Synchronization_Relist
    extends Ess_M2ePro_Model_Ebay_Synchronization_Templates_Synchronization_Abstract
{
        ...
        foreach ($synchTemplateCollection as $synchTemplate) {
            ...
            foreach ($listingsProducts as $listingProduct) {
                ...
                try {
                    ...
                    if (!$this->getInspector()->isMeetRelistRequirements($listingProduct, false)) {
                        continue;
                    }
    ...
    private function getNextScheduledListingsProducts($synchTemplateId)
    {
        ...
        if (is_null($configData)) {
            ...
            $configData = Mage::helper('M2ePro')->jsonDecode($configData);
        }
        ...
        $cacheConfig->setGroupValue(
            ...
            Mage::helper('M2ePro')->jsonEncode($configData)
        );
