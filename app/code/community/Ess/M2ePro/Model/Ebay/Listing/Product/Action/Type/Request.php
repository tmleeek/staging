    ...
    extends Ess_M2ePro_Model_Ebay_Listing_Product_Action_Request
{
    ...
    protected function collectMetadata()
    {
        foreach ($this->requests as $requestObject) {
            /** @var Ess_M2ePro_Model_Ebay_Listing_Product_Action_Type_Request $requestObject */
    ...
    {
        /** @var Ess_M2ePro_Helper_Component_Ebay_Images $imagesHelper */
        $imagesHelper = Mage::helper('M2ePro/Component_Ebay_Images');
