    ...
    extends Ess_M2ePro_Model_Ebay_Listing_Product_Action_Type_Request
{
    ...
    protected function afterBuildDataEvent()
    {
        ...
        if ($params['replaced_action'] == Ess_M2ePro_Model_Listing_Product::ACTION_STOP) {

            $this->getConfigurator()->setPriority(
                Ess_M2ePro_Model_Ebay_Listing_Product_Action_Configurator::PRIORITY_REVISE_INSTEAD_OF_STOP
            );

        } elseif ($params['replaced_action'] == Ess_M2ePro_Model_Listing_Product::ACTION_RELIST) {

            $this->getConfigurator()->setPriority(
                Ess_M2ePro_Model_Ebay_Listing_Product_Action_Configurator::PRIORITY_REVISE_INSTEAD_OF_RELIST
            );
        }
    }
