...
final class Ess_M2ePro_Model_Buy_Synchronization_Templates_Synchronization
    extends Ess_M2ePro_Model_Buy_Synchronization_Templates_Abstract
{
    ...
    protected function beforeStart()
    {
        ...
        $this->runner->setConnectorModel('Buy_Connector_Product_Dispatcher');
        ...
        $this->inspector = Mage::getModel('M2ePro/Buy_Synchronization_Templates_Synchronization_Inspector');
    }
