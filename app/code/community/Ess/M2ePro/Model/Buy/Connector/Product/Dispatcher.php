...
class Ess_M2ePro_Model_Buy_Connector_Product_Dispatcher
{
        ...
        switch ($action) {
            ...
            case Ess_M2ePro_Model_Listing_Product::ACTION_LIST:
                $result = $this->processGroupedProducts(
                    $sortedProductsData,
                    100,
                    'Buy_Connector_Product_List_MultipleRequester',
                    $params
                );
                break;
            ...
            case Ess_M2ePro_Model_Listing_Product::ACTION_RELIST:
                $result = $this->processGroupedProducts(
                    $sortedProductsData,
                    1000,
                    'Buy_Connector_Product_Relist_MultipleRequester',
                    $params
                );
                break;
            ...
            case Ess_M2ePro_Model_Listing_Product::ACTION_REVISE:
                $result = $this->processGroupedProducts(
                    $sortedProductsData,
                    1000,
                    'Buy_Connector_Product_Revise_MultipleRequester',
                    $params
                );
                break;
            ...
            case Ess_M2ePro_Model_Listing_Product::ACTION_STOP:
                $result = $this->processGroupedProducts(
                    $sortedProductsData,
                    1000,
                    'Buy_Connector_Product_Stop_MultipleRequester',
                    $params
                );
                break;
    ...
    protected function processProducts(array $products, $connectorName, array $params = array())
    {
        try {
            ...
            $dispatcher = Mage::getModel('M2ePro/Buy_Connector_Dispatcher');

            /** @var Ess_M2ePro_Model_Buy_Connector_Product_Requester $connector */
