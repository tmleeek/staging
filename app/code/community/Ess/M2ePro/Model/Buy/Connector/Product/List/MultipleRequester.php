...
class Ess_M2ePro_Model_Buy_Connector_Product_List_MultipleRequester
    extends Ess_M2ePro_Model_Buy_Connector_Product_Requester
{
    ...
    {
        return 'Buy_Connector_Product_List_ProcessingRunner';
    }
    ...
    private function processSkuExistenceValidateAndFilter()
    {
        ...
        foreach ($listingProductsPacks as $listingProductsPack) {
            ...
            try {
                ...
                // TODO
                // Search was temporary disabled. At this moment, Rakuten.com does not update
                // the inventory report on its FTP, so we can't get correct inventory information

                /** @var $dispatcherObject Ess_M2ePro_Model_Buy_Connector_Dispatcher */
