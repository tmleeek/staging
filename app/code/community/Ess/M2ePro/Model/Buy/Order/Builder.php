...
class Ess_M2ePro_Model_Buy_Order_Builder extends Mage_Core_Model_Abstract
{
    ...
    {
        $this->setData('billing_address', Mage::helper('M2ePro')->jsonEncode($this->getData('billing_address')));
        $this->setData('shipping_address', Mage::helper('M2ePro')->jsonEncode($this->getData('shipping_address')));
