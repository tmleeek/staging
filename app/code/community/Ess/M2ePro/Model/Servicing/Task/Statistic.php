...
class Ess_M2ePro_Model_Servicing_Task_Statistic extends Ess_M2ePro_Model_Servicing_Task
{
    ...
    public function getRequestData()
    {
        ...
        try {
            ...
            //todo temporary solution for investigation of the problem
            //Mage::helper('M2ePro/Module_Exception')->process($e);
            $tempException = new Ess_M2ePro_Model_Servicing_Task_Statistic_Exception(
                $e->getMessage(), array(), $e->getCode()
            );
            Mage::helper('M2ePro/Module_Exception')->process($tempException);
    ...
    private function appendSettingsInfo($data)
    {
        ...
        $data['settings']['track_direct'] = $syncConfig->getGroupValue('/global/magento_products/inspector/','mode');
    ...
    private function appendListingsProductsInfo($data)
    {
        ...
        $tableListingProduct = $resource->getTableName('m2epro_listing_product');
        $tableAmazonListingProduct = $resource->getTableName('m2epro_amazon_listing_product');
        $tableProductEntity = $resource->getTableName('catalog_product_entity');
