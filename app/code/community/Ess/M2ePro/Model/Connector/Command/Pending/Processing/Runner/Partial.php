...
class Ess_M2ePro_Model_Connector_Command_Pending_Processing_Runner_Partial
    extends Ess_M2ePro_Model_Connector_Command_Pending_Processing_Runner
{
    ...
    protected function eventBefore()
    {
        ...
        $requesterPartial = Mage::getModel('M2ePro/Connector_Command_Pending_Requester_Partial');
