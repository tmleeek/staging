...
final class Ess_M2ePro_Model_Cron_Task_ConnectorRequesterPendingSingle extends Ess_M2ePro_Model_Cron_Task_Abstract
{
    ...
    {
        $collection = Mage::getResourceModel('M2ePro/Connector_Command_Pending_Requester_Single_Collection');
        ...
        /** @var Ess_M2ePro_Model_Connector_Command_Pending_Requester_Single[] $failedItems */
    ...
    private function completeExpiredItems()
    {
        ...
        /** @var Ess_M2ePro_Model_Connector_Command_Pending_Requester_Single[] $expiredItems */
    ...
    private function processCompletedItems()
    {
        ...
        /** @var Ess_M2ePro_Model_Connector_Command_Pending_Requester_Single[] $requesterSingleObjects */
    ...
    private function completeRequesterPendingSingle(
        Ess_M2ePro_Model_Connector_Command_Pending_Requester_Single $requesterPendingSingle,
