...
final class Ess_M2ePro_Model_Cron_Task_AmazonActions extends Ess_M2ePro_Model_Cron_Task_Abstract
{
    ...
    {
        $actionsProcessor = Mage::getModel('M2ePro/Amazon_Actions_Processor');
