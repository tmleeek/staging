...
final class Ess_M2ePro_Model_Cron_Task_ConnectorRequesterPendingPartial extends Ess_M2ePro_Model_Cron_Task_Abstract
{
    ...
    {
        $collection = Mage::getResourceModel('M2ePro/Connector_Command_Pending_Requester_Partial_Collection');
        ...
        /** @var Ess_M2ePro_Model_Connector_Command_Pending_Requester_Partial[] $failedItems */
    ...
    private function completeExpiredItems()
    {
        ...
        /** @var Ess_M2ePro_Model_Connector_Command_Pending_Requester_Partial[] $expiredItems */
    ...
    private function processCompletedItems()
    {
        ...
        /** @var Ess_M2ePro_Model_Connector_Command_Pending_Requester_Partial[] $requesterPartialObjects */
