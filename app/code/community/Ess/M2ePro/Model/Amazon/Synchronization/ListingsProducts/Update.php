...
final class Ess_M2ePro_Model_Amazon_Synchronization_ListingsProducts_Update
    extends Ess_M2ePro_Model_Amazon_Synchronization_ListingsProducts_Abstract
{
    ...
    private function processAccount(Ess_M2ePro_Model_Account $account)
    {
        ...
        if ($collection->getSize()) {
            ...
            $connectorObj = $dispatcherObject->getCustomConnector(
                'Amazon_Synchronization_ListingsProducts_Update_Requester', array(), $account
            );
    ...
    private function isLockedAccount(Ess_M2ePro_Model_Account $account)
    {
        ...
        $lockItem->setNick(
            Ess_M2ePro_Model_Amazon_Synchronization_ListingsProducts_Update_ProcessingRunner::LOCK_ITEM_PREFIX
            .'_'.$account->getId()
        );
