...
class Ess_M2ePro_Model_Amazon_Synchronization_Orders_Refund_Responser
    extends Ess_M2ePro_Model_Amazon_Connector_Orders_Refund_ItemsResponser
{
    ...
    public function failDetected($messageText)
    {
        ...
        $this->order->addErrorLog('Amazon Order status was not refunded. Reason: %msg%', array('msg' => $messageText));
    }
    ...
    protected function processResponseData()
    {
        ...
        foreach ($messagesSet->getEntities() as $message) {
            ...
            if ($message->isError()) {
                ...
                $this->order->addErrorLog(
                    'Amazon Order status was not refunded. Reason: %msg%',
        ...
        //----------------------
        $this->order->getLog()->setInitiator(Ess_M2ePro_Helper_Data::INITIATOR_EXTENSION);
        $this->order->addSuccessLog('Amazon Order status was refunded.');
        //----------------------
    }
