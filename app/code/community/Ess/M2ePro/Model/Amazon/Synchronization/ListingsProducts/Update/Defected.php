...
final class Ess_M2ePro_Model_Amazon_Synchronization_ListingsProducts_Update_Defected
    extends Ess_M2ePro_Model_Amazon_Synchronization_ListingsProducts_Abstract
{
    ...
    private function isLockedAccount(Ess_M2ePro_Model_Account $account)
    {
        ...
        $lockItem->setNick(
            Ess_M2ePro_Model_Amazon_Synchronization_ListingsProducts_Update_Defected_ProcessingRunner::LOCK_ITEM_PREFIX
            .'_'.$account->getId()
        );
