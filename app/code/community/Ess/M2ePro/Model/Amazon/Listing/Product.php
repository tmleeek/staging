...
class Ess_M2ePro_Model_Amazon_Listing_Product extends Ess_M2ePro_Model_Component_Child_Amazon_Abstract
{
    ...
    /**
     * @return Ess_M2ePro_Model_Amazon_Template_ShippingTemplate | null
     */
    public function getShippingTemplateTemplate()
    {
        ...
        return Mage::helper('M2ePro')->getCachedObject(
            'Amazon_Template_ShippingTemplate', $this->getTemplateShippingTemplateId(), NULL, array('template')
        );
    }
    ...
    */
    ...
    {
        $this->getResource()->setSynchStatusNeedByDescriptionTemplate($newData,$oldData,$this->getData());
        ...
        $this->getResource()->setSynchStatusNeedByShippingTemplate($newData,$oldData,$this->getData(),
                                                                   $modelName, $fieldName);

        $this->getResource()->setSynchStatusNeedByProductTaxCodeTemplate($newData,$oldData,$this->getData(),
                                                                         $modelName, $fieldName);
    }
