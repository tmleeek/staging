...
{
    /**
     * @var Ess_M2ePro_Model_Amazon_Template_ShippingTemplate
     */
    ...
    private function getShippingData()
    {
        ...
        $data = array();
        $data['shipping_data']['template_name'] =
            $this->getAmazonListingProduct()->getShippingTemplateSource()->getTemplateName();
