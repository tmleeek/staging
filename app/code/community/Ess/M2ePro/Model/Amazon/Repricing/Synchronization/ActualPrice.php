    ...
    extends Ess_M2ePro_Model_Amazon_Repricing_Synchronization_Abstract
{
    ...
    public function run($skus = NULL)
    {
        $existedSkus = array_unique(array_merge(
            Mage::getResourceModel('M2ePro/Amazon_Listing_Product_Repricing')->getAllSkus($this->getAccount(), false),
            Mage::getResourceModel('M2ePro/Amazon_Listing_Other')->getAllRepricingSkus($this->getAccount(), false)
        ));
