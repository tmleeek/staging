...
echo 'return=='.$returnedMAC .'==correct'. $correctMAC;*/
    ...
    public function errorAction()
    {
        ...
        $errorBlock = $this->getLayout()->createBlock('cms/block')->setBlockId('paymenterror')->toHtml();
       	 Mage::getSingleton('checkout/session')->addError(Mage::helper('sales')->__($errorBlock));       
        $this->_redirect('checkout/cart');
    }
